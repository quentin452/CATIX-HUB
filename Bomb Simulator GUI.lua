...
local TEST = library:AddWindow("Catix Hub / Bomb Simulator                                                                       By:I'm A Cat#7202 And Altix#3395")
...
local Tp = TEST:AddTab("Teleport")
    ...
    Farming:AddLabel("******************************************************************************")
      Farming:AddLabel("")
      Farming:AddLabel("Auto Farm")
      Farming:AddSwitch("Zone 1", function(bool)
    _G.Farm1 = (bool and true or false)
    while _G.Farm1 and wait() do
if game.Players.LocalPlayer.Character:FindFirstChild("Humanoid") and game.Players.LocalPlayer.Character:FindFirstChild("Humanoid").Health ~= 0 then
local me = game.Players.LocalPlayer.Character
local pbosd = game:GetService("Workspace").Resources.Regions[1].SpawnedBombs["1.15"].BoundingBox
me.HumanoidRootPart.CFrame = pbosd.CFrame + Vector3.new(0,0,0)
end  
end
	end)
	local Switch = Farming:AddSwitch("Auto Quests", function(bool)
    _G.Quests = (bool and true or false)
    while _G.Quests and wait() do
game:GetService("ReplicatedStorage").Events.Server.RequestQuestClaim:InvokeServer("Deal Damage")
game:GetService("ReplicatedStorage").Events.Server.RequestQuestClaim:InvokeServer("Max Hat Level")
game:GetService("ReplicatedStorage").Events.Server.RequestQuestClaim:InvokeServer("Unlock Next Area")
game:GetService("ReplicatedStorage").Events.Server.RequestQuestClaim:InvokeServer("Buy Next Weapons")
end  
	end)
	local Switch = Farming:AddSwitch("Auto Collect Gems,Coins", function(bool)
    _G.Collect = (bool and true or false)
    while _G.Collect and wait() do
local Me = game.Players.LocalPlayer.Character.HumanoidRootPart
local To = game:GetService("Workspace").Resources.Pickups.Coin
To.CFrame = Me.CFrame
local Me = game.Players.LocalPlayer.Character.HumanoidRootPart
local To = game:GetService("Workspace").Resources.Pickups.Gem
To.CFrame = Me.CFrame
end  
	end)	
		Farming:AddLabel("")
...
game:GetService("ReplicatedStorage").Events.Server.EggInvoke:InvokeServer(unpack(args))
end
end)
   Eggs:AddLabel("")
       Eggs:AddLabel("******************************************************************************")
...
for i,v in pairs(game.Players:GetChildren()) do
 ...
 local Tpm2Selected
  local Tpm2 = Tp:AddDropdown("Select Island", function(Selected)
        Tpm2Selected = Selected
  if game.Players.LocalPlayer.Character:FindFirstChild("Humanoid") and game.Players.LocalPlayer.Character:FindFirstChild("Humanoid").Health ~= 0 then
local me = game.Players.LocalPlayer.Character
local pbosd = game:GetService("Workspace").Resources.Portals[Tpm2Selected]
me.HumanoidRootPart.CFrame = pbosd.CFrame + Vector3.new(0,1,0)
end
end)

for i,v in pairs(game:GetService("Workspace").Resources.Portals:GetChildren()) do
    Tpm2:Add(v.name)
end
 Tp:AddLabel("")
       Tp:AddLabel("******************************************************************************")

...
local rs = game:GetService("RunService").RenderStepped
 venyx:Notify("Bacon Simulator", "Joins Discord's Server ! (By I'm A Cat#7202,Altix#3395)")
...
ThingsSec:addToggle("Auto Click", nil, function(bool)
 _G.Click1 = (bool and true or false)
    while _G.Click1 and rs:wait()do
...
ThingsSec1:addToggle("Auto Buy Bacon", nil, function(bool)
 _G.Bacon = (bool and true or false)
    while _G.Bacon and rs:wait(0)do
game:GetService("ReplicatedStorage").Events.BuyAllEvent:InvokeServer("Bacon")
end
end)
ThingsSec1:addToggle("Auto Buy Dna", nil, function(bool)
 _G.Dna = (bool and true or false)
    while _G.Dna and rs:wait(0)do
...
local EggsS = PageEgg:addSection("Auto Buy Eggs:")
            ...
            EggsS:addToggle("Buy Eggs x1", nil, function(value)
                shared.toggleEgg2 = value
            end)
            spawn(function()
                while wait() do
                    if shared.toggleEgg2 then
               game:GetService("ReplicatedStorage").Events.OpenEgg:FireServer(_G.EggSelected,1)
if game.Players.LocalPlayer.Character:FindFirstChild("Humanoid") and game.Players.LocalPlayer.Character:FindFirstChild("Humanoid").Health ~= 0 then
local me = game.Players.LocalPlayer.Character
local pbosd = game:GetService("Workspace").Eggs[_G.EggSelected].Part
me.HumanoidRootPart.CFrame = pbosd.CFrame + Vector3.new(0,10.5,0)
end
                    end
                end
            end)

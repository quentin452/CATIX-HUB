...
game:GetService("ReplicatedStorage").Events.SpitFire:InvokeServer()
        end
    else
        _G.e3= false
    end
...
AutoTab:CreateToggle("Auto Tp To Small chest", function(arg) --the (arg) is if the checkbox is toggled or not
    if arg then
        _G.e2 = true 
...
local pbosd = game:GetService("Workspace").ChestSpawns.Small
...
AutoTab:CreateToggle("Auto Tp To Medium chest", function(arg) --the (arg) is if the checkbox is toggled or not
    if arg then
        _G.e4 = true 
...
local me = game.Players.LocalPlayer.Character
local pbosd = game:GetService("Workspace").ChestSpawns.Medium
...
AutoTab:CreateToggle("Auto Tp To Large chest", function(arg) --the (arg) is if the checkbox is toggled or not
    if arg then
        _G.e5 = true 
...
local me = game.Players.LocalPlayer.Character
local pbosd = game:GetService("Workspace").ChestSpawns.Large
...
AutoTab:CreateToggle("Auto Tp To Very Large chest", function(arg) --the (arg) is if the checkbox is toggled or not
    if arg then
        _G.e6 = true 
...
local me = game.Players.LocalPlayer.Character
local pbosd = game:GetService("Workspace").ChestSpawns["Very Large"]
...
AutoTab:CreateToggle("Auto Tp To Molten chest", function(arg) --the (arg) is if the checkbox is toggled or not
    if arg then
        _G.e7 = true 
...
local me = game.Players.LocalPlayer.Character
local pbosd = game:GetService("Workspace").ChestSpawns.Molten
...
AutoTab:CreateToggle("Auto Tp To Sandy chest", function(arg) --the (arg) is if the checkbox is toggled or not
    if arg then
        _G.e8 = true 
...
local me = game.Players.LocalPlayer.Character
local pbosd = game:GetService("Workspace").ChestSpawns.Sandy
...
AutoTab:CreateToggle("Auto Tp To Toxic chest", function(arg) --the (arg) is if the checkbox is toggled or not
    if arg then
        _G.e9 = true 
...
local me = game.Players.LocalPlayer.Character
local pbosd = game:GetService("Workspace").ChestSpawns.Toxic
...
AutoTab:CreateToggle("Auto Tp To Dark chest", function(arg) --the (arg) is if the checkbox is toggled or not
    if arg then
        _G.e10 = true 
...
local me = game.Players.LocalPlayer.Character
local pbosd = game:GetService("Workspace").ChestSpawns.Dark
...
AutoTab:CreateToggle("Auto Tp To Heaven chest", function(arg) --the (arg) is if the checkbox is toggled or not
    if arg then
        _G.e11 = true 
...
local me = game.Players.LocalPlayer.Character
local pbosd = game:GetService("Workspace").ChestSpawns.Heaven
...
eggs:CreateToggle("Auto Buy SandEgg", function(arg) --the (arg) is if the checkbox is toggled or not
    if arg then
        _G.p = true 
        while wait(0) and _G.p do
...
local args = {
    [1] = 1,
    [2] = workspace["Pet Eggs"]["Sand Egg"].Data,
}
...
eggs:CreateToggle("Auto Buy ToxicEgg", function(arg) --the (arg) is if the checkbox is toggled or not
    if arg then
        _G.q = true 
        while wait(0) and _G.q do
...
local args = {
    [1] = 1,
    [2] = workspace["Pet Eggs"]["Toxic Egg"].Data,
}
...
eggs:CreateToggle("Auto Buy 1MEgg", function(arg) --the (arg) is if the checkbox is toggled or not
    if arg then
        _G.r = true 
...
local args = {
    [1] = 1,
    [2] = workspace["Pet Eggs"]["1 Mil  Visits Egg Display"]["1M Visits Egg"].Data,
}
...
eggs:CreateToggle("Auto Buy Monochrome Egg", function(arg) --the (arg) is if the checkbox is toggled or not
    if arg then
        _G.s = true 
...
local args = {
    [1] = 1,
    [2] = workspace["Pet Eggs"]["Monochrome Egg"].Data,
}
...
eggs:CreateToggle("Auto Buy Heaven Egg", function(arg) --the (arg) is if the checkbox is toggled or not
    if arg then
        _G.t = true 
...
local args = {
    [1] = 1,
    [2] = workspace["Pet Eggs"]["Heavenly Egg"].Data,
}
...
game.Players.LocalPlayer.character.HumanoidRootPart.CFrame = CFrame.new(704.197388, 211.060577, -804.918518)
end)
teleports:CreateButton("Zone 6", function() --you dont need "arg" for a button
game.Players.LocalPlayer.character.HumanoidRootPart.CFrame = CFrame.new(-1084.11951, 160.816147, 425.903534)
end)
teleports:CreateButton("Zone 7", function() --you dont need "arg" for a button
game.Players.LocalPlayer.character.HumanoidRootPart.CFrame = CFrame.new(-1256.67371, 189.978806, -123.864616)
end)
teleports:CreateButton("Zone 8", function() --you dont need "arg" for a button
game.Players.LocalPlayer.character.HumanoidRootPart.CFrame = CFrame.new(-116.547157, 222.748901, 696.697754)
end)
--| Anti KICK |
local mt = getrawmetatable(game)
local old = mt.__namecall

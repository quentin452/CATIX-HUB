...
ThingsSec:addToggle("Auto Click(faster)", nil, function(bool)
 _G.Click = bool
    while _G.Click and rs:wait()do
        for i,v in pairs(game:GetService("Players"):GetChildren()) do
   game:GetService("ReplicatedStorage").Systems.Clicking.RemoteEvents[v.Name]:FireServer()
end
end
end)
ThingsSec:addToggle("Auto Sell X1,5", nil, function(bool)
 _G.Sell2 = bool
    while _G.Sell2 and rs:wait()do
   local Me = game.Players.LocalPlayer.Character.HumanoidRootPart
local To = game:GetService("Workspace").Islands["Moon Outpost"].SellZone.SellTouch
To.CFrame = Me.CFrame
end
end)
ThingsSec:addToggle("Auto Sell(Mars Need Proficient Rank)", nil, function(bool)
 _G.Sell3 = bool
    while _G.Sell3 and rs:wait()do
   local Me = game.Players.LocalPlayer.Character.HumanoidRootPart
local To = game:GetService("Workspace").Islands.Mars.SellZone.SellTouch
To.CFrame = Me.CFrame
end
end)
ThingsSec:addToggle("Auto Collect Best Gems", nil, function(bool)
 _G.Collect = bool
    while _G.Collect and rs:wait()do
        if game.Players.LocalPlayer.Character:FindFirstChild("Humanoid") and game.Players.LocalPlayer.Character:FindFirstChild("Humanoid").Health ~= 0 then
for i, v in next, game:GetService("Workspace").CurrencyZones["The Aether"].Drops.Single:GetChildren() do
   if  v.Name == "Gem" then
...
ThingsSec:addToggle("Auto Collect Best Bag", nil, function(bool)
 _G.Collectb = bool
    while _G.Collectb and rs:wait()do
        if game.Players.LocalPlayer.Character:FindFirstChild("Humanoid") and game.Players.LocalPlayer.Character:FindFirstChild("Humanoid").Health ~= 0 then
for i, v in next, game:GetService("Workspace").CurrencyZones["The Aether"].Drops.Bag:GetChildren() do
   if  v.Name == "Bag" then
     v.CFrame = root.CFrame
       rs:wait()
   end
...
ThingsSec:addToggle("Auto Collect Best Safe", nil, function(bool)
 _G.Collectc = bool
    while _G.Collectc and rs:wait()do
        if game.Players.LocalPlayer.Character:FindFirstChild("Humanoid") and game.Players.LocalPlayer.Character:FindFirstChild("Humanoid").Health ~= 0 then
for i, v in next, game:GetService("Workspace").CurrencyZones["The Aether"].Drops.Safe:GetChildren() do
   if  v.Name == "Safe" then
     v.CFrame = root.CFrame
        rs:wait()
   end
...
local ThingsSec2 = Things:addSection("Auto Buy:")
ThingsSec2:addToggle("Auto Buy Potions", nil, function(bool)
 _G.Potions = bool
    while _G.Potions and rs:wait(0.1)do
     game:GetService("ReplicatedStorage").Systems.Upgrade.BuyAllUpgrades:InvokeServer("Potions")
end
end)
ThingsSec2:addToggle("Auto Buy Dnas", nil, function(bool)
 _G.Dnas = bool
    while _G.Dnas and rs:wait(0.1)do
game:GetService("ReplicatedStorage").Systems.Upgrade.BuyAllUpgrades:InvokeServer("Dna")
end
end)
ThingsSec2:addButton("Tp To Shop", function()
local Me = game.Players.LocalPlayer.Character.HumanoidRootPart
local To = game:GetService("Workspace").Islands.Home.ShopZone.MeshPart
Me.CFrame = To.CFrame
end)
    local PageEgg = venyx:addPage("Eggs", 6252259606)
local EggsS = PageEgg:addSection("Auto Buy Eggs:")
            local   SelectEggsStrings = {}
            for i,v in pairs(game:GetService("Workspace").EggKiosks:GetChildren()) do
            ...
            spawn(function()
                while wait() do
                 ...
                 game:GetService("ReplicatedStorage").Systems.Egg.OpenEgg:InvokeServer(_G.EggSelected,1)
                    end
                end
            end)

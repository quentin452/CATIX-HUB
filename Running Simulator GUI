--https://www.roblox.com/games/3182399976/X10-ENERGY-Running-Simulator-NEW



local Library = loadstring(game:HttpGet("https://raw.githubusercontent.com/preztel/AzureLibrary/master/uilib.lua", true))()

local AutoTab = Library:CreateTab("Running Simulator GUI","things", true)
...
AutoTab:CreateToggle("Auto Click FAST", function(arg) 
    if arg then
        _G.a = true 
...
AutoTab:CreateToggle("Auto Prestige FREE", function(arg)
    if arg then
        _G.c = true 

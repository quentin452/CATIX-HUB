--https://www.roblox.com/games/3206773017/PETS-Chopping-Tree-Simulator

local Library = loadstring(game:HttpGet("https://raw.githubusercontent.com/preztel/AzureLibrary/master/uilib.lua", true))()

local AutoTab = Library:CreateTab("Chopping-Tree-Simulator GUI","things", true)
...
game:GetService("ReplicatedStorage").Upgrades:FireServer(unpack(args))
local args = {
    [1] = "AxeU2",
}
...
AutoTab:CreateToggle("Auto Collect Sell,Quest,chests", function(arg) --the (arg) is if the checkbox is toggled or not
    if arg then
        _G.a = true 
...
AutoTab:CreateToggle("Auto Tp To Trees", function(arg) --the (arg) is if the checkbox is toggled or not
    if arg then
        _G.b = true 
        while wait(0) and _G.b do
local me = game.Players.LocalPlayer.Character
local pbosd = game:GetService("Workspace").Trees.LowPolyTree.Log

me.HumanoidRootPart.CFrame = CFrame.new(pbosd.Position.X-0, pbosd.Position.Y-0, pbosd.Position.Z+3)
local args = {
    [1] = workspace.Trees.LowPolyTree.Log,
}

game:GetService("ReplicatedStorage").Chop:FireServer(unpack(args))
local args = {
    [1] = workspace.Trees.LowPolyTree.Log,
}

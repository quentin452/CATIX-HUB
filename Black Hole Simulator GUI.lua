--https://www.roblox.com/games/2933728926/Black-Hole-Simulator

local Library = loadstring(game:HttpGet("https://raw.githubusercontent.com/preztel/AzureLibrary/master/uilib.lua", true))()

local AutoTab = Library:CreateTab("Black-Hole-Simulator GUI","things", true)
...
AutoTab:CreateToggle("Auto Buy Black Hole", function(arg) --the (arg) is if the checkbox is toggled or not
    if arg then
        _G.LULU = true 
...
game:GetService("ReplicatedStorage").Remotes.PurchaseEverything:InvokeServer(unpack(args))
end
...
AutoTab:CreateToggle("Auto Buy Energys", function(arg) --the (arg) is if the checkbox is toggled or not
    if arg then
        _G.a = true 
...
AutoTab:CreateToggle("Auto Collect ", function(arg) --you dont need "arg" for a button
    if arg then
        _G.c = true 
        while wait(0) and _G.c do
for i,v in pairs(game.Workspace.Essentials.Objects[1]:GetDescendants()) do
...
AutoTab:CreateButton("tP tO Sell ", function() --you dont need "arg" for a button

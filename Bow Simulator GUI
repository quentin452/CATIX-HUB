...
local w3 = library:CreateWindow("Bow Simulator GUI")
local w2 = library:CreateWindow("Eggs")
local w4 = library:CreateWindow("Hats")
local w5 = library:CreateWindow("Boss")
--================== Model =======================--
...
w:Label("Hacks",Color3.fromRGB(38,38,38),Color3.fromRGB(0,216,111)) --BgColor,TextColor
	...
	w:Toggle("Auto Click",function(bool)
		...
		w:Toggle("Auto Buy Bows",function(bool)
		shared.toggle3= bool
end) 
	w:Toggle("Auto Buy Quivers",function(bool)
		shared.toggle4 = bool
end) 
...
local w2 = w2:CreateFolder("Eggs")
	w2:Dropdown("Choose Eggs",{"Shiny","Dominus","Frost","Plastic","Sandy","Golden","Rubby","Dragon","Glow","Tier2","Tier1"},true,function(mob) --Replace the Dropdown name with the selected one(A,B,C)
	    _G.BossSelected = mob
	end)
...
game:GetService("ReplicatedStorage").Communication.RE:FireServer(unpack(args))
			elseif _G.BossSelected == "Plastic" then
		local args = {
    [1] = "OpenEgg",
    [2] = 1,
    [3] = "Plastic8",
...
game:GetService("ReplicatedStorage").Communication.RE:FireServer(unpack(args))	
			elseif _G.BossSelected == "Golden" then
	local args = {
    [1] = "OpenEgg",
    [2] = 1,
    [3] = "Golden6",
...
game:GetService("ReplicatedStorage").Communication.RE:FireServer(unpack(args))
	elseif _G.BossSelected == "Ruby" then
	local args = {
    [1] = "OpenEgg",
    [2] = 1,
    [3] = "Ruby5",
...
game:GetService("ReplicatedStorage").Communication.RE:FireServer(unpack(args))
elseif _G.BossSelected == "Glow" then
	local args = {
    [1] = "OpenEgg",
    [2] = 1,
    [3] = "Glow4",
...
game:GetService("ReplicatedStorage").Communication.RE:FireServer(unpack(args))
elseif _G.BossSelected == "Tier1" then
	local args = {
    [1] = "OpenEgg",
    [2] = 1,
    [3] = "Tier 1",
...
local w4 = w4:CreateFolder("Hats")
	w4:Dropdown("Choose Hats",{"Tier6","Tier5","Tier4","Tier3","Tier2","Tier1"},true,function(mob) --Replace the Dropdown name with the selected one(A,B,C)
	    _G.HatsSelected = mob
	end)

	w4:Toggle("Buy Hats",function(bool)
	    shared.Hats = bool
	end)
...
game:GetService("ReplicatedStorage").Communication.RE:FireServer(unpack(args))
	elseif _G.HatsSelected == "Tier5" then
	local args = {
    [1] = "OpenEgg",
    [2] = 1,
    [3] = "Tier 5",
...
game:GetService("ReplicatedStorage").Communication.RE:FireServer(unpack(args))
	elseif _G.HatsSelected == "Tier4" then
	local args = {
    [1] = "OpenCrate",
    [2] = 1,
    [3] = "Tier 4",
...
game:GetService("ReplicatedStorage").Communication.RE:FireServer(unpack(args))
elseif _G.HatsSelected == "Tier3" then
	local args = {
    [1] = "OpenCrate",
    [2] = 1,
    [3] = "Tier 3",
...
game:GetService("ReplicatedStorage").Communication.RE:FireServer(unpack(args))
elseif _G.HatsSelected == "Tier2" then
	local args = {
    [1] = "OpenCrate",
    [2] = 1,
    [3] = "Tier 2",
...
game:GetService("ReplicatedStorage").Communication.RE:FireServer(unpack(args))
elseif _G.HatsSelected == "Tier1" then
	local args = {
    [1] = "OpenCrate",
    [2] = 1,
    [3] = "Tier 1",
...
local w5 = w5:CreateFolder("Boss")
	w5:Dropdown("Choose Boss",{"Boss"},true,function(mob) --Replace the Dropdown name with the selected one(A,B,C)
	    _G.MeowSelected = mob
	end)

	w5:Toggle("Tp Boss",function(bool)
	    shared.TARGET = bool
	end)
...
if _G.MeowSelected == "Boss" then
local me = game.Players.LocalPlayer.Character
local pbosd = game:GetService("Workspace")["Boss Modules"]["Boss Module"].Boss.HumanoidRootPart

me.HumanoidRootPart.CFrame = CFrame.new(pbosd.Position.X-0, pbosd.Position.Y+50, pbosd.Position.Z+0)
			end
		end
	end
end)
...
local mause = game.Players.LocalPlayer:GetMouse() do
local mouse = game:GetService("Players").LocalPlayer:GetMouse();
local inputService = game:GetService('UserInputService');
local heartbeat = game:GetService("RunService").Heartbeat;
function Draggable(frame)
local s, event = pcall(function()
return frame.MouseEnter end) 
if s then
frame.Active = true;
...
loadstring(game:HttpGetAsync("https://raw.githubusercontent.com/quentin452/CATIX-HUB/master/DEX%20EXPLORER"))() end)

	PLR:Button("Remote Spy",function()
loadstring(game:HttpGet("https://raw.githubusercontent.com/quentin452/CATIX-HUB/master/!Remote%20Spy", true))() end)

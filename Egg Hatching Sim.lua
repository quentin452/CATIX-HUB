...
local rs = game:GetService("RunService").RenderStepped
 venyx:Notify("Egg Hatching Simulator", "Joins Discord's Server ! (By I'm A Cat#7202,Altix#3395)")
...
ThingsSec:addToggle("Auto Click", nil, function(bool)
 _G.Click = (bool and true or false)
    while _G.Click and rs:wait(0.1)do
game:GetService("ReplicatedStorage").Network.clickCoin:FireServer()
end
end)
ThingsSec:addToggle("Auto Crowns", nil, function(bool)
 _G.Crowns = (bool and true or false)
    while _G.Crowns and rs:wait(0.1)do
game:GetService("ReplicatedStorage").Network.clickCrown:FireServer()
end
end)
ThingsSec:addToggle("Auto Delete All Pet Unlocked", nil, function(bool)
 _G.Delete = (bool and true or false)
    while _G.Delete and rs:wait()do
game:GetService("ReplicatedStorage").Network.deleteAll:FireServer()
end
end)
    local PageEgg = venyx:addPage("Eggs", 6252259606)
local EggsS = PageEgg:addSection("Auto Buy Eggs:")
            local   SelectEggsStrings = {}
            for i,v in pairs(game:GetService("Workspace").Things.Eggs:GetChildren()) do
            ...
            spawn(function()
                while wait() do
                    if shared.toggle then
                       game:GetService("ReplicatedStorage").Network.openEgg:InvokeServer(_G.EggSelected,false)
                       if game.Players.LocalPlayer.Character:FindFirstChild("Humanoid") and game.Players.LocalPlayer.Character:FindFirstChild("Humanoid").Health ~= 0 then
local me = game.Players.LocalPlayer.Character
local pbosd = game:GetService("Workspace").Things.Eggs[_G.EggSelected].key
me.HumanoidRootPart.CFrame = pbosd.CFrame + Vector3.new(0,0,0)
end
                    end
                     if shared.toggle1 then
  game:GetService("ReplicatedStorage").Network.openEgg:InvokeServer(_G.EggSelected,true)
                       if game.Players.LocalPlayer.Character:FindFirstChild("Humanoid") and game.Players.LocalPlayer.Character:FindFirstChild("Humanoid").Health ~= 0 then
local me = game.Players.LocalPlayer.Character
local pbosd = game:GetService("Workspace").Things.Eggs[_G.EggSelected].key
me.HumanoidRootPart.CFrame = pbosd.CFrame + Vector3.new(0,0,0)

...
local w3 = library:CreateWindow("Armor Simulator: Resurgence")

local w = w3:CreateFolder("Hacks")

w:Label("Things",Color3.fromRGB(38,38,38),Color3.fromRGB(0,216,111)) --BgColor,TextColor

w:Button("Buy Classes",function()
for i = 1,100 do 
    wait()
game:GetService("ReplicatedStorage").ExtraRemotes.ClassUpgrade:FireServer(i)
end end)

	w:Toggle("Auto Power :D",function(bool)
		shared.toggle1 = bool end)
	
		w:Toggle("Sell(use inf jump)",function(bool)
		shared.toggle22 = bool end) 
w:Toggle("Auto Buy Backpacks",function(bool)
		shared.toggle3 = bool end) 
	spawn(function()
		while wait() do
		       if shared.toggle1 then
game:GetService("ReplicatedStorage").GainPow:FireServer(0,math.huge,0) end
	if shared.toggle22 then
	local Me = game.Players.LocalPlayer.Character.HumanoidRootPart
local To = game:GetService("Workspace").SellShop.SellBrick
To.CFrame = Me.CFrame
game.Players.LocalPlayer.Character.Humanoid.Jump = true
end
	if shared.toggle3 then
game:GetService("ReplicatedStorage").ExtraRemotes.BagUpgrade:FireServer()
end end end)
--================== Player Settings =======================--
--(alot not by me )--
...
walkspeedmouse.KeyDown:connect(x_walkspeed) end)
...
loadstring(game:HttpGetAsync("https://pastebin.com/raw/fPP8bZ8Z"))() end)
...
local CS = w3:CreateFolder("Credits")
	CS:Button("Script: I'm A Cat#7202",function()
		setclipboard("Im A Cat#7202") end)
	CS:Button("Discord: https://discord.gg/KmHZUpXEmQ",function()
    setclipboard("https://discord.gg/KmHZUpXEmQ")  end) 
CS:Button("Helped by: Altix#3395",function()
		setclipboard("Altix#3395") end)
	CS:DestroyGUI()
--================== Autres =======================--
--| Anti Ban |

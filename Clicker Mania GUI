--https://www.roblox.com/games/5658257666/Islands-Clicker-Mania?refPageId=85991ac9-90f3-477b-b1dc-9ba073939141

local Library = loadstring(game:HttpGet("https://raw.githubusercontent.com/preztel/AzureLibrary/master/uilib.lua", true))()

local AutoTab = Library:CreateTab("Clicker-Mania GUI","things", true)
...
game:GetService("ReplicatedStorage").Remotes.ClickEvent:FireServer()
game:GetService("ReplicatedStorage").Remotes.ClickEvent:FireServer()
game:GetService("ReplicatedStorage").Remotes.ClickEvent:FireServer()
game:GetService("ReplicatedStorage").Remotes.ClickEvent:FireServer()
game:GetService("ReplicatedStorage").Remotes.ClickEvent:FireServer()
...
rebirths:CreateToggle("Auto Buy Sr Rebirths", function(arg) --the (arg) is if the checkbox is toggled or not
    if arg then
        _G.b = true 
        while wait(0.1) and _G.b do


game:GetService("ReplicatedStorage").Remotes.UltraRebirth:FireServer()
...
game:GetService("ReplicatedStorage").Remotes.RebirthsEvent:FireServer(unpack(args))
end
...
rebirths:CreateToggle("Auto Buy Rebirths x1B", function(arg) --the (arg) is if the checkbox is toggled or not
    if arg then
        _G.l = true 
...
rebirths:CreateToggle("Auto Buy Rebirths x10B", function(arg) --the (arg) is if the checkbox is toggled or not
    if arg then
        _G.m = true 
...
eggs:CreateToggle("Go To Eggs To Work", function(arg) --the (arg) is if the checkbox is toggled or not
...
workspace.Tiers.Model.RemoteEvent:FireServer()
game.Players.LocalPlayer.character.HumanoidRootPart.CFrame = CFrame.new(-34.7445107, 34.7041779, 35.5235252)
end

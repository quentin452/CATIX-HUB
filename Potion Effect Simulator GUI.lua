...
local TEST = library:AddWindow("Catix Hub / Potion Effect Simulator                                                                 By:I'm A Cat#7202 And Altix#3395")
...
local To = game:GetService("Workspace").Map.Shops.Sell.SellPart
To.CFrame = Me.CFrame
end
end)
		Farming:AddLabel("")
...
game:GetService("ReplicatedStorage").Aero.AeroRemoteServices.PetService.PetHatch:InvokeServer(unpack(args))
end
end)
   Eggs:AddLabel("")
       Eggs:AddLabel("******************************************************************************")
...
local EggsS = Tp:AddDropdown("Select Teleporters", function(Selected)
     sselected = Selected
     if game.Players.LocalPlayer.Character:FindFirstChild("Humanoid") and game.Players.LocalPlayer.Character:FindFirstChild("Humanoid").Health ~= 0 then
local me = game.Players.LocalPlayer.Character
local pbosd = game:GetService("Workspace").Map.Teleports[sselected]
me.HumanoidRootPart.CFrame = pbosd.CFrame + Vector3.new(0,0,0)
end
end)

for i, v in pairs(game:GetService("Workspace").Map.Teleports:GetChildren()) do
     EggsS:Add(v.Name)
end

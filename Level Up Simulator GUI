--https://www.roblox.com/games/5515646116/Level-Up-Simulator-BETA
...
local AutoTab = Library:CreateTab("Level Up Sim GUI","things", true)
...
AutoTab:CreateToggle("Auto Click Fast", function(arg) --the (arg) is if the checkbox is toggled or not
    if arg then
        ...
        while wait(0) and _G.a do
            game:GetService("ReplicatedStorage").AddExp:FireServer()
        end
    else
        _G.a = false
    end

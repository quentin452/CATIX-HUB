...
local rs = game:GetService("RunService").RenderStepped
 venyx:Notify("Tapping Craze", "Joins Discord's Server ! (By I'm A Cat#7202,Altix#3395)")
...
ThingsSec:addToggle("Auto Claim Daily Rewards", nil, function(bool)
 _G.Daily = (bool and true or false)
    while _G.Daily and rs:wait()do
for i, v in pairs(game:GetService("Workspace").Chests:GetChildren()) do
game:GetService("ReplicatedStorage").RemoteEvents.ClaimChest:FireServer(v.Name)
end
end
end)
ThingsSec:addToggle("Auto Equip Best Pet", nil, function(bool)
 _G.Best3 = (bool and true or false)
    while _G.Best3 and wait(5)do
...
local ThingsSec2 = Things:addSection("Rebirths:")
 ...
 game:GetService("ReplicatedStorage").RemoteEvents.Rebirth:FireServer(tonumber(_G.RebSelected))
                    end
                end
            end)
...
local EggsS = PageEgg:addSection("Auto Buy Eggs:")
            ...
            EggsS:addToggle("Buy Eggs x1", nil, function(value)
              ...
              EggsS:addToggle("Buy Eggs x3(need to join group game)", nil, function(value)
                shared.toggle1 = value
            end)
            spawn(function()
                while wait() do
                    if shared.toggle then
                        game:GetService("ReplicatedStorage").RemoteEvents.OpenEgg:FireServer(_G.EggSelected)
                        if game.Players.LocalPlayer.Character:FindFirstChild("Humanoid") and game.Players.LocalPlayer.Character:FindFirstChild("Humanoid").Health ~= 0 then
local me = game.Players.LocalPlayer.Character
local pbosd = game:GetService("Workspace").Eggs[_G.EggSelected].Bottom
me.HumanoidRootPart.CFrame = pbosd.CFrame + Vector3.new(0,0,0)
end
                    end
                     if shared.toggle1 then
                       game:GetService("ReplicatedStorage").RemoteEvents.OpenEgg:FireServer(_G.EggSelected,true)
                       if game.Players.LocalPlayer.Character:FindFirstChild("Humanoid") and game.Players.LocalPlayer.Character:FindFirstChild("Humanoid").Health ~= 0 then
local me = game.Players.LocalPlayer.Character
local pbosd = game:GetService("Workspace").Eggs[_G.EggSelected].Bottom
me.HumanoidRootPart.CFrame = pbosd.CFrame + Vector3.new(0,0,0)

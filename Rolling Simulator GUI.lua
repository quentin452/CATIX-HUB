--https://www.roblox.com/games/5268766951/Rolling-Simulator


local Library = loadstring(game:HttpGet("https://raw.githubusercontent.com/preztel/AzureLibrary/master/uilib.lua", true))()

local AutoTab = Library:CreateTab("Rolling-Simulator GUI","things", true)
...
AutoTab:CreateToggle("Auto XP FAST", function(arg) --the (arg) is if the checkbox is toggled or not
    if arg then
        _G.LULU = true 
        while wait(0) and _G.LULU do
          
game:GetService("ReplicatedStorage").RemoteEvents.ExpGiver:FireServer()
game:GetService("ReplicatedStorage").RemoteEvents.ExpGiver:FireServer()
game:GetService("ReplicatedStorage").RemoteEvents.ExpGiver:FireServer()
game:GetService("ReplicatedStorage").RemoteEvents.ExpGiver:FireServer()
game:GetService("ReplicatedStorage").RemoteEvents.ExpGiver:FireServer()
...
game:GetService("ReplicatedStorage").RemoteEvents.RebirthRemote:FireServer()
end
...
game.Players.LocalPlayer.character.HumanoidRootPart.CFrame = CFrame.new(-36.4380569, 99.4845505, -850.903625)
end)

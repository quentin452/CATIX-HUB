...
AutoTab:CreateToggle("Auto SellX100", function(arg) --the (arg) is if the checkbox is toggled or not
    if arg then
        _G.se = true 
...
HIT:CreateToggle("Auto Hit Leprechaun", function(arg) --the (arg) is if the checkbox is toggled or not
    if arg then
        _G.h8 = true 
        while wait(0) and _G.h8 do
local args = {
...
HIT:CreateToggle("Auto Hit Evil Bunny", function(arg) --the (arg) is if the checkbox is toggled or not
    if arg then
        _G.h8 = true 
        while wait(0) and _G.h8 do
...
HIT:CreateButton("Tp To Boss 2", function() --you dont need "arg" for a button
...
eggs2:CreateToggle("Auto Buy Money Egg", function(arg) --the (arg) is if the checkbox is toggled or not
    if arg then
        _G.zio = true 
...
eggs2:CreateToggle("Auto Buy Tree Egg", function(arg) --the (arg) is if the checkbox is toggled or not
    if arg then
        _G.zip = true 
...
eggs2:CreateToggle("Auto Buy Ice Egg", function(arg) --the (arg) is if the checkbox is toggled or not
    if arg then
        _G.zip = true 
        while wait(0) and _G.zip do
...
teleports2:CreateButton("Zone 26", function() --you dont need "arg" for a button
game.Players.LocalPlayer.character.HumanoidRootPart.CFrame = CFrame.new(161.133774, 70453.8828, -552.661621)
end)
teleports2:CreateButton("Zone 25", function() --you dont need "arg" for a button
game.Players.LocalPlayer.character.HumanoidRootPart.CFrame = CFrame.new(211.957443, 68381.25, -479.738037)
end)
teleports2:CreateButton("Zone 24", function() --you dont need "arg" for a button
game.Players.LocalPlayer.character.HumanoidRootPart.CFrame = CFrame.new(270.572357, 65973.3672, -470.686066)
end)
teleports2:CreateButton("Zone 23", function() --you dont need "arg" for a button
game.Players.LocalPlayer.character.HumanoidRootPart.CFrame = CFrame.new(169.715515, 63692.0273, -443.743317)
end)
teleports2:CreateButton("Zone 22", function() --you dont need "arg" for a button
game.Players.LocalPlayer.character.HumanoidRootPart.CFrame = CFrame.new(228.572693, 60900.6406, -441.599518)
end)
teleports2:CreateButton("Zone 21", function() --you dont need "arg" for a button
game.Players.LocalPlayer.character.HumanoidRootPart.CFrame = CFrame.new(290.379517, 58501.0664, -461.26358)
end)
teleports2:CreateButton("Zone 20", function() --you dont need "arg" for a button

--https://www.roblox.com/games/5644352013/
...
w:Label("THINGS",Color3.fromRGB(38,38,38),Color3.fromRGB(0,216,111)) 
	...
	spawn(function()
		while wait() do
		       if shared.toggle1 then
		           wait(0.1)
for i,v in pairs(game:GetService("Players").LocalPlayer.PlayerGui.Menu.Menus.Upgrades.ScrollingFrame:GetChildren()) do
if v.name == UIGridLayout then else
game:GetService("ReplicatedStorage").Events.BuyUpgrade:FireServer(v.Name)
end
end
end
...
local w22 = w4:CreateFolder("Eggs")
	w22:Dropdown("Choose Eggs",{"Egg1","Egg2","Egg3","Egg4","Egg5","Egg6","Egg7","Egg8","Egg9","Egg10"},true,function(mob) --Replace the Dropdown name with the selected one(A,B,C)
	    _G.BossSelected = mob
	end)
...
elseif _G.EggsSelected == "Egg9" then
game:GetService("ReplicatedStorage").Events.BuyEgg:InvokeServer(workspace.EggSystem.Egg9)
elseif _G.EggsSelected == "Egg10" then
game:GetService("ReplicatedStorage").Events.BuyEgg:InvokeServer(workspace.EggSystem.Egg10)
			end
		end
	end
end)

--https://www.roblox.com/games/4952840577/50K-Zombie-Adventures

local Library = loadstring(game:HttpGet("https://raw.githubusercontent.com/preztel/AzureLibrary/master/uilib.lua", true))()

local AutoTab = Library:CreateTab("Zombie-Adventures GUI","things", true)
...
MISC:CreateButton("🎬NO CLIP PRESS (g)🎬", function() --the (arg) is if the checkbox is toggled or not
    _G.NO2 = true 
  noclip = false
...
MISC:CreateButton("💨Speed Hack 200 PRESS (f)💨", function() --the (arg) is if the checkbox is toggled or not
...
AutoTab:CreateToggle("Auto Brain Eat", function(arg) --the (arg) is if the checkbox is toggled or not
    if arg then
        _G.LULU = true 
        while wait(0.5) and _G.LULU do
    
local args = {
    [1] = true,
}

game:GetService("ReplicatedStorage").Remotes.BrainEat:FireServer(unpack(args))
end
...
AutoTab:CreateToggle("Auto Buy Feed Upgrades", function(arg) --the (arg) is if the checkbox is toggled or not
    if arg then
        _G.b = true 
...
game:GetService("ReplicatedStorage").Remotes.StatUpgrade:FireServer(unpack(args))
wait(0.1)
end
...
AutoTab:CreateToggle("Auto Buy Capacity Upgrades", function(arg) --the (arg) is if the checkbox is toggled or not
    if arg then
        _G.c = true 
...
AutoTab:CreateButton("Use No Clip", function() --you dont need "arg" for a button
game.Players.LocalPlayer.character.HumanoidRootPart.CFrame = CFrame.new(n)
end)
AutoTab:CreateButton("Impossible To Get Damage", function() --you dont need "arg" for a button
game.Players.LocalPlayer.character.HumanoidRootPart.CFrame = CFrame.new(n)
end)
AutoTab:CreateButton("Tp TO Mobs zone 1", function() --the (arg) is if the checkbox is toggled or not
 game.Players.LocalPlayer.character.HumanoidRootPart.CFrame = CFrame.new(-2017.71301, 14.5461264, -919.176697)
end)
AutoTab:CreateButton("Tp TO Mobs zone 2", function() --the (arg) is if the checkbox is toggled or not
 game.Players.LocalPlayer.character.HumanoidRootPart.CFrame = CFrame.new(-1694.50903, 11.154664, -1047.6001)
end)

AutoTab:CreateButton("Tp TO Mobs zone 4", function() --the (arg) is if the checkbox is toggled or not
 game.Players.LocalPlayer.character.HumanoidRootPart.CFrame = CFrame.new(386.554932, 15.9193649, -1049.07422)
end)
teleports:CreateButton("Eggs Zone", function() --you dont need "arg" for a button
game.Players.LocalPlayer.character.HumanoidRootPart.CFrame = CFrame.new(-1770.65833, 4.26364374, -967.789246)
end)

teleports:CreateButton("Zone 1", function() --you dont need "arg" for a button
game.Players.LocalPlayer.character.HumanoidRootPart.CFrame = CFrame.new(-1813.18652, 4.00753069, -1102.30432)
end)

teleports:CreateButton("Zone 2", function() --you dont need "arg" for a button
game.Players.LocalPlayer.character.HumanoidRootPart.CFrame = CFrame.new(-742.328186, 11.3860302, -1180.93579)
end)

teleports:CreateButton("Zone 3", function() --you dont need "arg" for a button
game.Players.LocalPlayer.character.HumanoidRootPart.CFrame = CFrame.new(-156.623871, 4.07750654, -1214.87744)
end)

teleports:CreateButton("Zone 4", function() --you dont need "arg" for a button
game.Players.LocalPlayer.character.HumanoidRootPart.CFrame = CFrame.new(301.77478, 12.6525459, -1126.16272)
end)

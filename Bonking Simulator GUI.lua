...
local rs = game:GetService("RunService").RenderStepped
 venyx:Notify("Bonking Simulator", "Joins Discord's Server ! (By I'm A Cat#7202,Altix#3395)")
...
ThingsSec:addToggle("Auto Sell", nil, function(bool)
    _G.Sell = bool
       while _G.Sell and rs:wait(0.1)do
        if game.Players.LocalPlayer.Character:FindFirstChild("Humanoid") and game.Players.LocalPlayer.Character:FindFirstChild("Humanoid").Health ~= 0 then
            local me = game.Players.LocalPlayer.Character
            local pbosd = game:GetService("Workspace").SellBlock
            me.HumanoidRootPart.CFrame = pbosd.CFrame + Vector3.new(0,-15,0)
            end
            wait(0.01)
            local me = game.Players.LocalPlayer.Character
            local pbosd = game:GetService("Workspace").SellBlock
            me.HumanoidRootPart.CFrame = pbosd.CFrame + Vector3.new(10,-1,0)
   end
end)
ThingsSec:addToggle("Auto Collect Gold,Gems", nil, function(bool)
    _G.Collect2 = bool
       while _G.Collect2 and rs:wait(0)do
...
ThingsSec:addToggle("Auto Buy Hax", nil, function(bool)
    _G.Hax = bool
       while _G.Hax and wait(0.5)do
...
ThingsSec:addToggle("Auto Buy Bags", nil, function(bool)
    _G.Bags = bool
       while _G.Bags and wait(0.5)do
game:GetService("ReplicatedStorage").Remotes.PurchaseAllWeps:FireServer(game:GetService("Players").LocalPlayer.PlayerGui.Shop.MainFrame.Shop.WepScrollingFrame,game:GetService("Players").LocalPlayer.PlayerGui.Shop.MainFrame.Shop.BonkTechScrollingFrame,false,true)
   end
end)
ThingsSec:addToggle("Auto Buy Rebirths", nil, function(bool)
    _G.Rebirths = bool
       while _G.Rebirths and wait(1)do
           for i,v in pairs(game:GetService("Players").LocalPlayer.PlayerGui.Shop.MainFrame.Shop.RebirthScrollingFrame:GetChildren()) do
game:GetService("ReplicatedStorage").Remotes.PurchaseRebirth:FireServer(v.Name,game:GetService("Players").LocalPlayer.PlayerGui.Shop.MainFrame.Shop.RebirthScrollingFrame)
  end
   end
end)
...
me.HumanoidRootPart.CFrame = pbosd.CFrame + Vector3.new(0,7.5,0)
end
                    end
                end
            end)
ThingsSec:addButton("Destroy Gamepass Shop", function(bool)
  game:GetService("Players").LocalPlayer.PlayerGui.GamepassShop:Destroy()
end)
ThingsSec:addButton("DESTROY GAMEPASS SHOP = YOU CANT OPPEN OTHER UI", function(bool)
   end)

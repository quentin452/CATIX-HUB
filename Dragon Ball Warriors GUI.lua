...
local w3 = library:CreateWindow("Dragon Ball Warriors GUI")
local w2 = library:CreateWindow("Farm All(bugged)")


--================== Model =======================--

local w2 = w2:CreateFolder("Things")

w2:Label("Auto All(bugged)",Color3.fromRGB(38,38,38),Color3.fromRGB(0,216,111)) --BgColor,TextColor

w2:Button("Arrest Auto Ki",function()
game:GetService("ReplicatedStorage").Remotes.Training.ChargeFinish:FireServer()

end)
w2:Button("Auto All(use auto click)",function()
local args = {
...
game:GetService("ReplicatedStorage").Events.DuroDe:InvokeServer(unpack(args))
game:GetService("ReplicatedStorage").Remotes.Training.FlightData:FireServer()
 local args = {
    [1] = game:GetService("Players").LocalPlayer.Stats,
    [2] = {
...
game:GetService("ReplicatedStorage").Events.Transformatico:InvokeServer(unpack(args))
local args = {
...
game:GetService("ReplicatedStorage").Events.Kamehameha:InvokeServer(unpack(args))
local args = {
    [1] = game:GetService("Players").LocalPlayer.Status,
    [2] = game:GetService("Players").LocalPlayer.Stats,
    [3] = game:GetService("Players").LocalPlayer.Character.HumanoidRootPart,
...
game:GetService("ReplicatedStorage").Remotes.Training.Dodge:InvokeServer(unpack(args))
local args = {
    [1] = game:GetService("Players").LocalPlayer.Stats,
    [2] = game:GetService("Players").LocalPlayer.Status,
    [3] = game:GetService("Players").LocalPlayer.Character.Humanoid,
...
w:Button("Auto kameHameha(Use Auto Click)",function()
local args = {
    [1] = game:GetService("Players").LocalPlayer.Status,
    [2] = game:GetService("Players").LocalPlayer.Stats,
    [3] = game:GetService("Players").LocalPlayer.Character.HumanoidRootPart,
...
w:Button("Auto Power Lvl(use auto click)",function()
 local args = {
    [1] = game:GetService("Players").LocalPlayer.Stats,
    [2] = {
        ["LeftLowerArm"] = game:GetService("Players").LocalPlayer.Character.LeftLowerArm,
...
game:GetService("ReplicatedStorage").Events.Transformatico:InvokeServer(unpack(args)) local args = {
    [1] = game:GetService("Players").LocalPlayer.Stats,
    [2] = {
        ["LeftLowerArm"] = game:GetService("Players").LocalPlayer.Character.LeftLowerArm,
        ["RightUpperArm"] = game:GetService("Players").LocalPlayer.Character.RightUpperArm,
...
w:Button("Auto Ki(use auto click)",function()
local args = {
    [1] = game:GetService("Players").LocalPlayer.Status,
    [2] = game:GetService("Players").LocalPlayer.Character.UpperTorso,
    [3] = game:GetService("Players").LocalPlayer.Character.Humanoid,
...
w:Button("Arrest Auto Ki",function()
game:GetService("ReplicatedStorage").Remotes.Training.ChargeFinish:FireServer()
...
w:Button("Auto Agility(use auto click)",function()
local args = {
    [1] = game:GetService("Players").LocalPlayer.Status,
    [2] = game:GetService("Players").LocalPlayer.Stats,
    [3] = game:GetService("Players").LocalPlayer.Character.HumanoidRootPart,
...
w:Button("Auto Defence(use auto click)",function()
local args = {
    [1] = game:GetService("Players").LocalPlayer.Stats,
    [2] = game:GetService("Players").LocalPlayer.Status,
    [3] = game:GetService("Players").LocalPlayer.Character.Humanoid,

...
local rs = game:GetService("RunService").RenderStepped
 venyx:Notify("Milk Simulator", "Joins Discord's Server ! (By I'm A Cat#7202,Altix#3395)")
...
ThingsSec:addToggle("Auto Click X10(Normal Ping)", nil, function(bool)
    _G.ClickX10 = bool
       while _G.ClickX10 and rs:wait()do
        for i = 1,10 do
            game:GetService("ReplicatedStorage").Knit.Services.MilkService.RE.Drink:FireServer()
            end
   end
end)
ThingsSec:addToggle("Auto Click X100", nil, function(bool)
    _G.ClickX100 = bool
       while _G.ClickX100 and rs:wait()do
        for i = 1,100 do
            game:GetService("ReplicatedStorage").Knit.Services.MilkService.RE.Drink:FireServer()
            end
   end
end)
ThingsSec:addToggle("Auto Click X500(Raise Ping)", nil, function(bool)
    _G.ClickX500 = bool
       while _G.ClickX500 and rs:wait()do
        for i = 1,500 do
            game:GetService("ReplicatedStorage").Knit.Services.MilkService.RE.Drink:FireServer()
            end
   end
end)
ThingsSec:addToggle("Auto Buy Milk", nil, function(bool)
    _G.Milk = bool
       while _G.Milk and rs:wait(0.1)do
   game:GetService("ReplicatedStorage").Knit.Services.ShopService.RF.BuyAll:InvokeServer("Milk")
   end
end)
ThingsSec:addToggle("Auto Buy Dna", nil, function(bool)
    _G.Dna = bool
       while _G.Dna and rs:wait(0.1)do
   game:GetService("ReplicatedStorage").Knit.Services.ShopService.RF.BuyAll:InvokeServer("DNA")
   end
end)
ThingsSec:addToggle("Auto Buy Class", nil, function(bool)
    _G.Class = bool
       while _G.Class and rs:wait(0.1)do
    ...
    _G.Sell = bool
       while _G.Sell and rs:wait()do
        if game.Players.LocalPlayer.Character:FindFirstChild("Humanoid") and game.Players.LocalPlayer.Character:FindFirstChild("Humanoid").Health ~= 0 then
            ...
            local pbosd = game:GetService("Workspace").CirclePads.Sell.Forcefield
            ...
            local me = game.Players.LocalPlayer.Character
            local pbosd = game:GetService("Workspace").CirclePads.Sell.Forcefield
            me.HumanoidRootPart.CFrame = pbosd.CFrame + Vector3.new(15,0,0)
            end
   end
end)
ThingsSec:addToggle("Auto Collect Gems(laggy)", nil, function(bool)
    _G.Gems = bool
       while _G.Gems and rs:wait(0.1)do
      for i,v in pairs(game:GetService("Workspace").Pickups:GetChildren()) do
    if game.Players.LocalPlayer.Character:FindFirstChild("Humanoid") and game.Players.LocalPlayer.Character:FindFirstChild("Humanoid").Health ~= 0 then
    local Me = game.Players.LocalPlayer.Character.HumanoidRootPart
    local To = v.HumanoidRootPart
    To.CFrame = Me.CFrame
   end
end
end
 ...
 local PageEgg = venyx:addPage("Eggs", 6252259606)
   local EggsS = PageEgg:addSection("Auto Buy Eggs FAST:")
               EggsS:addDropdown("Select Egg",  {
           "Common","Uncommon","Rare","Candy","Sweet","Sand","Water"},function(value)
                   _G.EggSelected2 = value
               end)
               ...
               spawn(function()
                   while wait() do
                       if shared.toggle then
                              if _G.EggSelected2 == "Common" then
                            if game.Players.LocalPlayer.Character:FindFirstChild("Humanoid") and game.Players.LocalPlayer.Character:FindFirstChild("Humanoid").Health ~= 0 then
                            local Me = game.Players.LocalPlayer.Character.HumanoidRootPart
                            local To = game:GetService("Workspace").Lobby.MainAreas.Eggs.Lobby[1]["_fakePlatform"]
                            To.CFrame = Me.CFrame
                            end
                             game:GetService("ReplicatedStorage").Knit.Services.PetService.RF.HatchEgg:InvokeServer(workspace.Lobby.MainAreas.Eggs.Lobby["1"])
                              elseif _G.EggSelected2 == "Uncommon" then
                                   if game.Players.LocalPlayer.Character:FindFirstChild("Humanoid") and game.Players.LocalPlayer.Character:FindFirstChild("Humanoid").Health ~= 0 then
                            local Me = game.Players.LocalPlayer.Character.HumanoidRootPart
                            local To = game:GetService("Workspace").Lobby.MainAreas.Eggs.Lobby[2]["_fakePlatform"]
                            To.CFrame = Me.CFrame
                            end
                             game:GetService("ReplicatedStorage").Knit.Services.PetService.RF.HatchEgg:InvokeServer(workspace.Lobby.MainAreas.Eggs.Lobby["2"])
                              elseif _G.EggSelected2 == "Rare" then
                                   if game.Players.LocalPlayer.Character:FindFirstChild("Humanoid") and game.Players.LocalPlayer.Character:FindFirstChild("Humanoid").Health ~= 0 then
                            local Me = game.Players.LocalPlayer.Character.HumanoidRootPart
                            local To = game:GetService("Workspace").Lobby.MainAreas.Eggs.Lobby[3]["_fakePlatform"]
                            To.CFrame = Me.CFrame
                            end
                             game:GetService("ReplicatedStorage").Knit.Services.PetService.RF.HatchEgg:InvokeServer(workspace.Lobby.MainAreas.Eggs.Lobby["3"])
                              elseif _G.EggSelected2 == "Candy" then
                                   if game.Players.LocalPlayer.Character:FindFirstChild("Humanoid") and game.Players.LocalPlayer.Character:FindFirstChild("Humanoid").Health ~= 0 then
                            local Me = game.Players.LocalPlayer.Character.HumanoidRootPart
                            local To = game:GetService("Workspace").Lobby.MainAreas.Eggs.Candy[1]["_fakePlatform"]
                            To.CFrame = Me.CFrame
                            end
                             game:GetService("ReplicatedStorage").Knit.Services.PetService.RF.HatchEgg:InvokeServer(workspace.Lobby.MainAreas.Eggs.Candy["1"])
                              elseif _G.EggSelected2 == "Sweet" then
                                   if game.Players.LocalPlayer.Character:FindFirstChild("Humanoid") and game.Players.LocalPlayer.Character:FindFirstChild("Humanoid").Health ~= 0 then
                            local Me = game.Players.LocalPlayer.Character.HumanoidRootPart
                            local To = game:GetService("Workspace").Lobby.MainAreas.Eggs.Candy[2]["_fakePlatform"]
                            To.CFrame = Me.CFrame
                            end
                             game:GetService("ReplicatedStorage").Knit.Services.PetService.RF.HatchEgg:InvokeServer(workspace.Lobby.MainAreas.Eggs.Candy["2"])
                              elseif _G.EggSelected2 == "Sand" then
                                   if game.Players.LocalPlayer.Character:FindFirstChild("Humanoid") and game.Players.LocalPlayer.Character:FindFirstChild("Humanoid").Health ~= 0 then
                            local Me = game.Players.LocalPlayer.Character.HumanoidRootPart
                            local To = game:GetService("Workspace").Lobby.MainAreas.Eggs.Beach[1]["_fakePlatform"]
                            To.CFrame = Me.CFrame
                            end
                             game:GetService("ReplicatedStorage").Knit.Services.PetService.RF.HatchEgg:InvokeServer(workspace.Lobby.MainAreas.Eggs["Beach "]["1"])
                              elseif _G.EggSelected2 == "Water" then
                                   if game.Players.LocalPlayer.Character:FindFirstChild("Humanoid") and game.Players.LocalPlayer.Character:FindFirstChild("Humanoid").Health ~= 0 then
                            local Me = game.Players.LocalPlayer.Character.HumanoidRootPart
                            local To = game:GetService("Workspace").Lobby.MainAreas.Eggs.Beach[2]["_fakePlatform"]
                            To.CFrame = Me.CFrame
                            end
                             game:GetService("ReplicatedStorage").Knit.Services.PetService.RF.HatchEgg:InvokeServer(workspace.Lobby.MainAreas.Eggs["Beach "]["2"])
                           end
                       end
                   end
               end)

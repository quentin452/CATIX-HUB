...
local AutoTab = Library:CreateTab("Lifting Simulator GUI","things", true)
...
MISC:CreateButton("Speed Hack 100 Press(A)Or(E)", function() --the (arg) is if the checkbox is toggled or not
...
AutoTab:CreateToggle("Auto Buy Weights ", function(arg) --the (arg) is if the checkbox is toggled or not
    if arg then
        _G.d = true 
...
AutoTab:CreateToggle("Auto Buy Tier ", function(arg) --the (arg) is if the checkbox is toggled or not
    if arg then
        _G.f = true 
...
AutoTab:CreateToggle("Auto Buy Morphs ", function(arg) --the (arg) is if the checkbox is toggled or not
    if arg then
        _G.g = true 
...
AutoTab:CreateToggle("Auto Boss Kill Aura ", function(arg) --the (arg) is if the checkbox is toggled or not
    if arg then
        _G.i= true 
...
AutoTab:CreateToggle("Auto Magma Boss Kill Aura ", function(arg) --the (arg) is if the checkbox is toggled or not
    if arg then
        _G.j= true 
...
AutoTab:CreateButton("Disable Pop Ups ", function() --the (arg) is if the checkbox is toggled or not
 for i,v in pairs(game:GetService("ReplicatedStorage").Assets.UI:GetChildren()) do

       if v.Name == "Sell Effect" or v.Name == "Effect" then
...
eggs:CreateButton("Auto Buy Normal Eggs", function(arg) --the (arg) is if the checkbox is toggled or not
    if arg then
        _G.k= true 
        while wait(0) and _G.k do
    game:GetService("ReplicatedStorage").Events["Buy Pet"]:FireServer("Normal")
        end
    else
        _G.k  =false
    end
end)
eggs:CreateButton("Auto Buy Spiky Eggs", function(arg) --the (arg) is if the checkbox is toggled or not
    if arg then
        _G.l= true 
        while wait(0) and _G.l do
   game:GetService("ReplicatedStorage").Events["Buy Pet"]:FireServer("Spiky")
end
    else
        _G.l  =false
    end
end)
eggs:CreateButton("Auto Buy Fancy Eggs", function(arg) --the (arg) is if the checkbox is toggled or not
    if arg then
        _G.m= true 
        while wait(0) and _G.m do
       game:GetService("ReplicatedStorage").Events["Buy Pet"]:FireServer("Fancy")
end
    else
        _G.m  =false
    end
end)
eggs:CreateButton("Auto Buy Golden Eggs", function(arg) --the (arg) is if the checkbox is toggled or not
    if arg then
        _G.n= true 
        while wait(0) and _G.n do
       game:GetService("ReplicatedStorage").Events["Buy Pet"]:FireServer("Golden")
end
    else
        _G.n  =false
    end
end)
eggs:CreateButton("Auto Buy Ghost Eggs", function(arg) --the (arg) is if the checkbox is toggled or not
    if arg then
        _G.o= true 
        while wait(0) and _G.o do
       game:GetService("ReplicatedStorage").Events["Buy Pet"]:FireServer("Ghost")
end
    else
        _G.o  =false
    end
end)
eggs:CreateButton("Auto Buy Sand Eggs", function(arg) --the (arg) is if the checkbox is toggled or not
    if arg then
        _G.p= true 
        while wait(0) and _G.p do
       game:GetService("ReplicatedStorage").Events["Buy Pet"]:FireServer("Sand")
end
    else
        _G.p  =false
    end
end)
eggs:CreateButton("Auto Buy Fiery Eggs", function(arg) --the (arg) is if the checkbox is toggled or not
    if arg then
        _G.q= true 
        while wait(0) and _G.q do
       game:GetService("ReplicatedStorage").Events["Buy Pet"]:FireServer("Fiery")
end
    else
        _G.q  =false
    end
end)
eggs:CreateButton("Auto Buy Infernal Eggs", function(arg) --the (arg) is if the checkbox is toggled or not
    if arg then
        _G.r = true 
        while wait(0) and _G.r do
       game:GetService("ReplicatedStorage").Events["Buy Pet"]:FireServer("Infernal")
end
    else
        _G.r  =false
    end
end)
eggs:CreateButton("Auto Buy Winter Eggs", function(arg) --the (arg) is if the checkbox is toggled or not
    if arg then
        _G.s= true 
        while wait(0) and _G.s do
       game:GetService("ReplicatedStorage").Events["Buy Pet"]:FireServer("Winter")
end
    else
        _G.s  =false
    end
end)
eggs:CreateButton("Auto Buy Dark Eggs", function(arg) --the (arg) is if the checkbox is toggled or not
    if arg then
        _G.t= true 
        while wait(0) and _G.t do
       game:GetService("ReplicatedStorage").Events["Buy Pet"]:FireServer("Dark")
end
    else
        _G.t  =false
    end
end)
eggs:CreateButton("Auto Buy Divine Eggs", function(arg) --the (arg) is if the checkbox is toggled or not
    if arg then
        _G.u= true 
        while wait(0) and _G.u do
       game:GetService("ReplicatedStorage").Events["Buy Pet"]:FireServer("Divine")
end
    else
        _G.u  =false
    end
end)
eggs:CreateButton("Auto Buy Mythical Eggs", function(arg) --the (arg) is if the checkbox is toggled or not
    if arg then
        _G.v= true 
        while wait(0) and _G.v do
       game:GetService("ReplicatedStorage").Events["Buy Pet"]:FireServer("Mythical")
end
    else
        _G.v  =false
    end
end)
eggs:CreateButton("Auto Buy Overlord Eggs", function(arg) --the (arg) is if the checkbox is toggled or not
    if arg then
        _G.w= true 
        while wait(0) and _G.w do
       game:GetService("ReplicatedStorage").Events["Buy Pet"]:FireServer("Overlord")
end
    else
        _G.w  =false
    end
end)
eggs:CreateButton("Auto Buy Wraith Eggs", function(arg) --the (arg) is if the checkbox is toggled or not
    if arg then
        _G.x= true 
        while wait(0) and _G.x do
       game:GetService("ReplicatedStorage").Events["Buy Pet"]:FireServer("Wraith")
end
    else
        _G.x  =false
    end
end)
eggs:CreateButton("Auto Buy Magic Eggs", function(arg) --the (arg) is if the checkbox is toggled or not
    if arg then
        _G.y= true 
        while wait(0) and _G.y do
       game:GetService("ReplicatedStorage").Events["Buy Pet"]:FireServer("Magic")
end
    else
        _G.y  =false
    end
end)
eggs:CreateButton("Auto Buy Cosmic Eggs", function(arg) --the (arg) is if the checkbox is toggled or not
    if arg then
        _G.z= true 
        while wait(0) and _G.z do
       game:GetService("ReplicatedStorage").Events["Buy Pet"]:FireServer("Cosmic")
end
    else
        _G.z  =false
    end
end)
eggs:CreateButton("Auto Buy Golden Mystic Eggs", function(arg) --the (arg) is if the checkbox is toggled or not
    if arg then
        _G.za= true 
        while wait(0) and _G.za do
       game:GetService("ReplicatedStorage").Events["Buy Pet"]:FireServer("Golden Mystic")
end
    else
        _G.za  =false
    end
end)
eggs:CreateButton("Auto Buy Forbidden Eggs", function(arg) --the (arg) is if the checkbox is toggled or not
    if arg then
        _G.zb= true 
        while wait(0) and _G.zb do
       game:GetService("ReplicatedStorage").Events["Buy Pet"]:FireServer("Forbidden")
end
    else
        _G.zb  =false
    end
end)
eggs:CreateButton("Auto Buy Swamp Eggs", function(arg) --the (arg) is if the checkbox is toggled or not
    if arg then
        _G.zc= true 
        while wait(0) and _G.zc do
       game:GetService("ReplicatedStorage").Events["Buy Pet"]:FireServer("Swamp")
end
    else
        _G.zc  =false
    end
...
game.Players.LocalPlayer.character.HumanoidRootPart.CFrame = CFrame.new(-70.135849, 40.6160431, -8.74903297)
end)



teleports:CreateToggle("Best Zone", function(arg) --you dont need "arg" for a button
   if arg then
_G.zd= true 
        while wait(0) and _G.zd do
game.Players.LocalPlayer.character.HumanoidRootPart.CFrame = CFrame.new(1970.37158, 1801.73694, 1426.20056)
end
    else
        _G.zd  =false
    end

...
AutoTab:CreateToggle("Auto Tp Zone Soul", function(arg) --you dont need "arg" for a button
  if arg then
  _G.so = true 
        while wait(0) and _G.so  do
game.Players.LocalPlayer.character.HumanoidRootPart.CFrame = CFrame.new(2474.46606, 199.171417, -1412.17725)

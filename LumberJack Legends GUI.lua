--https://www.roblox.com/games/4379619839/Lumberjack-Legends

local Library = loadstring(game:HttpGet("https://raw.githubusercontent.com/preztel/AzureLibrary/master/uilib.lua", true))()

local AutoTab = Library:CreateTab("Lumberjack-Legends GUI","things", true)
local teleports = Library:CreateTab("Teleports","things", true)
local MISC = Library:CreateTab("MISC","things","things", true)
local credits = Library:CreateTab("Credits","things","things", true)
...
game:GetService("ReplicatedStorage").TeleportToLastSellHoop:InvokeServer(unpack(args))
end
...
game:GetService("ReplicatedStorage").UnlockAllItemRequest:InvokeServer(unpack(args))
end
...
AutoTab:CreateToggle("Auto Buy Backpacks", function(arg) --the (arg) is if the checkbox is toggled or not
    if arg then
        _G.c = true 
...
AutoTab:CreateToggle("Auto Tp To VIP Trees", function(arg) --the (arg) is if the checkbox is toggled or not
    if arg then
        _G.d = true 
        while wait(0) and _G.d do

local me = game.Players.LocalPlayer.Character
local pbosd = game:GetService("Workspace").Village.VIP.Trees.ChoppableSakura01.Model

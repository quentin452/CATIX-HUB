...
local TEST = library:AddWindow("Catix Hub / Clicker Lords                                                                             By:I'm A Cat#7202 And Altix#3395")
...
local Tp = TEST:AddTab("Teleport")

    Farming:AddLabel("******************************************************************************")
      Farming:AddLabel("")
	Farming:AddLabel("Things")
Farming:AddButton("Auto Click(Click on FREE Clicker)", function()
game:GetService("Players").LocalPlayer.AutoValue.FreeClickerBuy.Value = true
	end)
	Farming:AddButton("Unlock Zone FREE", function()
for i,v in pairs(game:GetService("Players").LocalPlayer.PortalValue:GetChildren()) do
game:GetService("Players").LocalPlayer.PortalValue[v.Name].Value = true
end
	end)
		Farming:AddButton("Delete Anti Btools", function()
 	for i,v in pairs(game:GetService("Players").LocalPlayer.Backpack:GetChildren()) do
						if v.Name == "LocalScript" or v.Name == "Portals" or v.Name == "SpawnPortals" or v.Name == "CamScript1"  or v.Name == "HidePets" then
						else
game:GetService("Players").LocalPlayer.Backpack[v.Name]:Destroy()
end
end
	end)
		Farming:AddLabel("")
...
loadstring(game:HttpGet("https://raw.githubusercontent.com/quentin452/CATIX-HUB/master/!Remote%20Spy", true))()
 ...
 Eggs:AddSwitch("Auto Delete Common Pets", function(bool)
 _G.Common = (bool and true or false)
    while _G.Common and wait() do
for i,v in pairs(game:GetService("Players").LocalPlayer.PlayerGui.Main.PetInventory.MainFrame.Inventory:GetDescendants()) do
    if v.ClassName == "TextLabel" then
        if v.Name == "Common" then
            game:GetService("ReplicatedStorage").RemoteEvents.PetActionRequest:InvokeServer("Delete",{["PetID"] = v.Parent.Parent.Parent.Parent.PetID.Value})
        end
    end
end
end
end)
 Eggs:AddSwitch("Auto Delete Uncommon Pets", function(bool)
 _G.Uncommon = (bool and true or false)
    while _G.Uncommon and wait() do
for i,v in pairs(game:GetService("Players").LocalPlayer.PlayerGui.Main.PetInventory.MainFrame.Inventory:GetDescendants()) do
    if v.ClassName == "TextLabel" then
        if v.Name == "Uncommon" then
            game:GetService("ReplicatedStorage").RemoteEvents.PetActionRequest:InvokeServer("Delete",{["PetID"] = v.Parent.Parent.Parent.Parent.PetID.Value})
        end
    end
end
 ...
 Eggs:AddSwitch("Auto Delete Rare Pets", function(bool)
 _G.Rare = (bool and true or false)
    while _G.Rare and wait() do
for i,v in pairs(game:GetService("Players").LocalPlayer.PlayerGui.Main.PetInventory.MainFrame.Inventory:GetDescendants()) do
    if v.ClassName == "TextLabel" then
        if v.Name == "Rare" then
            game:GetService("ReplicatedStorage").RemoteEvents.PetActionRequest:InvokeServer("Delete",{["PetID"] = v.Parent.Parent.Parent.Parent.PetID.Value})
 ...
 Eggs:AddSwitch("Auto Delete Epic Pets", function(bool)
 _G.Epic = (bool and true or false)
    while _G.Epic and wait() do
for i,v in pairs(game:GetService("Players").LocalPlayer.PlayerGui.Main.PetInventory.MainFrame.Inventory:GetDescendants()) do
    if v.ClassName == "TextLabel" then
        if v.Name == "Epic" then
            game:GetService("ReplicatedStorage").RemoteEvents.PetActionRequest:InvokeServer("Delete",{["PetID"] = v.Parent.Parent.Parent.Parent.PetID.Value})
 ...
 Eggs:AddSwitch("Auto Delete Legendary Pets", function(bool)
 _G.Legendary = (bool and true or false)
    while _G.Legendary and wait() do
for i,v in pairs(game:GetService("Players").LocalPlayer.PlayerGui.Main.PetInventory.MainFrame.Inventory:GetDescendants()) do
    if v.ClassName == "TextLabel" then
...
Eggs:AddSwitch("Buy Eggs X1", function(bool)
 _G.ToggleEggd = (bool and true or false)
    while _G.ToggleEggd and wait() do
local args = {
    [1] = EggsSelected,
    [2] = "Single"
}
...
local pbosd = game:GetService("Workspace").Eggs[EggsSelected].Outline
me.HumanoidRootPart.CFrame = pbosd.CFrame + Vector3.new(0,3.5,0)
end
end
end)
   Eggs:AddLabel("")
...
Tp:AddLabel("")
       ...
       local Tpm = Tp:AddDropdown("Select Player", function(Selected)
    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = game.Players[tostring(Selected)].Character.HumanoidRootPart.CFrame
end)

for i,v in pairs(game.Players:GetChildren()) do
    Tpm:Add(v.name)
end
local IslandSelected
       local Tpmd = Tp:AddDropdown("Select Island", function(Selected)
              IslandSelected = Selected
              if game.Players.LocalPlayer.Character:FindFirstChild("Humanoid") and game.Players.LocalPlayer.Character:FindFirstChild("Humanoid").Health ~= 0 then
local me = game.Players.LocalPlayer.Character
local pbosd = game:GetService("Workspace").Portals[IslandSelected].stepportalpart
...
Tp:AddButton("Spawn", function()
  game.Players.LocalPlayer.character.HumanoidRootPart.CFrame = CFrame.new(-38.1067429, 8.52670002, 1031.59241)  
    end)
 Tp:AddLabel("")
       Tp:AddLabel("******************************************************************************")

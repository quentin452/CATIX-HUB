...
local page = venyx:addPage("Home", 6252243736)
 venyx:Notify("Ninja Rush", "Joins Discord's Server ! (By I'm A Cat#7202,Altix#3395)")
...
ThingsSec:addToggle("Auto click FAST(2)", nil, function(bool)
     _G.Toggle12 = (bool and true or false)
    while _G.Toggle12 and wait() do   
game:GetService("ReplicatedStorage").Combat_Attack:InvokeServer(true)
game:GetService("ReplicatedStorage").Combat_Attack:InvokeServer(true)
game:GetService("ReplicatedStorage").Combat_Attack:InvokeServer(true)
game:GetService("ReplicatedStorage").Combat_Attack:InvokeServer(true)

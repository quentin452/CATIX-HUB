...
ThingsSec:addToggle("Auto Sell X2", nil, function(bool)
 _G.Sell = bool
    while _G.Sell and rs:wait()do
         if game.Players.LocalPlayer.Character:FindFirstChild("Humanoid") and game.Players.LocalPlayer.Character:FindFirstChild("Humanoid").Health ~= 0 then
   local Me = game.Players.LocalPlayer.Character.HumanoidRootPart
local To = game:GetService("Workspace").Islands.island3.SellModel.Part
To.CFrame = Me.CFrame
end
end
end)
ThingsSec:addToggle("Auto Buy Tools", nil, function(bool)
 _G.Tools = bool
    while _G.Tools and wait(1)do
        for i,v in pairs (game:GetService("ReplicatedStorage").ToolStorage:GetChildren()) do
   game:GetService("ReplicatedStorage").Events.ToolsEvents.ToolBuy:FireServer(v.Name)
end
end
end)
ThingsSec:addToggle("Auto Buy Dnas", nil, function(bool)
 _G.Dnas = bool
    while _G.Dnas and wait(1)do
        for i,v in pairs (game:GetService("Players").LocalPlayer.Tpc:GetChildren()) do
game:GetService("ReplicatedStorage").Events.PackEvents.PackBuy:FireServer(v.Name)
end
end
end)
ThingsSec:addToggle("Auto Buy Classes", nil, function(bool)
 _G.Classes = bool
    while _G.Classes and wait(1)do
        for i,v in pairs (game:GetService("Players").LocalPlayer.Tpc:GetChildren()) do
game:GetService("ReplicatedStorage").Events.ClassEvents.ClassBuy:FireServer(v.Name)
end
end
end)
            ...
            spawn(function()
                while wait() do
                    if shared.toggle then
                      game:GetService("ReplicatedStorage").GameClient.Events.RemoteFunction.BuyEgg:InvokeServer(_G.EggSelected,"Buy1")
                    end
                end
            end)

--https://www.roblox.com/games/3652625463/HUGE-UPDATE-Lifting-Simulator
...
AutoTab:CreateButton("Safe Zone", function() --you dont need "arg" for a button
game.Players.LocalPlayer.character.HumanoidRootPart.CFrame = CFrame.new(-990.953308, 5182.95557, 1638.15381)
end)

AutoTab:CreateButton("Shop", function() --you dont need "arg" for a button
game.Players.LocalPlayer.character.HumanoidRootPart.CFrame = CFrame.new(-649.63739, -53.8859482, 1780.86084)
end)
--| Anti KICK |
local mt = getrawmetatable(game)
local old = mt.__namecall

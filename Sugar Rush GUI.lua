...
local Tp = TEST:AddTab("Teleports")
...
local Eggs = TEST:AddTab("Buy Eggs")
    ...
    if game.Players.LocalPlayer.Character:FindFirstChildOfClass("Tool") then
		...
		local Switch = Farming:AddSwitch("Auto Sell", function(bool)
    _G.Toggles22 = (bool and true or false)
    while _G.Toggles22 and wait() do
       local Me = game.Players.LocalPlayer.Character.HumanoidRootPart
local To = game:GetService("Workspace").Map.Lobby.Stores.Sell.SellButton.MiddleHighlight
To.CFrame = Me.CFrame
game.Players.LocalPlayer.Character.Humanoid.Jump = true

    end  
	end)
	local Switch = Farming:AddSwitch("Auto Buy Candy", function(bool)
    _G.Toggle3 = (bool and true or false)
    while _G.Toggle3 and wait() do
   	for i,v in pairs(game:GetService("Players").LocalPlayer.PlayerGui.Main["Candy Shop"].ShopFrame:GetChildren()) do wait(0.1)
						if v.Name == "UIPadding" or v.Name == "UIGridLayout" or v.Name == "UIAspectRatioConstraint" then
						else
...
game:GetService("ReplicatedStorage").Remotes.BuyCandy:FireServer(unpack(args))
		...
		local Switch = Farming:AddSwitch("Auto Buy Storage", function(bool)
    _G.Toggle4 = (bool and true or false)
    while _G.Toggle4 and wait() do
   	for i,v in pairs(game:GetService("Players").LocalPlayer.PlayerGui.Main["Skills Shop"].ShopFrame:GetChildren()) do wait(0.1)
						if v.Name == "UIPadding" or v.Name == "UIGridLayout" or v.Name == "UIAspectRatioConstraint" then
						else
...
game:GetService("ReplicatedStorage").Remotes.BuyStorage:FireServer(unpack(args))
				...
				local Switch = Farming:AddSwitch("Auto Buy Skills", function(bool)
    _G.Toggle4 = (bool and true or false)
    while _G.Toggle4 and wait() do
   	for i,v in pairs(game:GetService("Players").LocalPlayer.PlayerGui.Main["Storage Shop"].ShopFrame:GetChildren()) do wait(0.1)
						if v.Name == "UIPadding" or v.Name == "UIGridLayout" or v.Name == "UIAspectRatioConstraint" then
						else
...
game:GetService("ReplicatedStorage").Remotes.BuySkill:FireServer(unpack(args))
     ...
     Farming:AddButton("Oppen Shop", function()
    game:GetService("Players").LocalPlayer.PlayerGui.Main["Shop Pop Up"].Visible = true
 
     end)-- wait
     
       Farming:AddButton("Delete Storage Full Notif", function()
    game:GetService("Players").LocalPlayer.PlayerGui.Main["Storage Full"]:Destroy()
...
loadstring(game:HttpGet("https://raw.githubusercontent.com/quentin452/CATIX-HUB/master/!Remote%20Spy", true))()
     ...
     misc:AddButton("Get Some Gamepasses (many display issue cases)", function()
          for i,v in pairs(game:GetService("Players").LocalPlayer.PlayerGui.Main.Shop.GamepassFrame[1].Image:GetChildren()) do
                    v.Value = true
                end
     end)
     ...
     Tp:AddLabel("******************************************************************************")
        Tp:AddLabel("")
local TpSelected
local Tpto = Tp:AddDropdown("Select Teleport", function(Selected)
     TpSelected = Selected
end)

for i, v in pairs(game:GetService("Workspace").IslandsTouch:GetChildren()) do
     Tpto:Add(v.Name)
end

Tp:AddButton("Tp To...", function()
local me = game.Players.LocalPlayer.Character
local pbosd = game:GetService("Workspace").IslandsTouch[TpSelected]
...
workspace.Eggs[EggSelected].Event:FireServer()

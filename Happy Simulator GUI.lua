...
local rs = game:GetService("RunService").RenderStepped
 venyx:Notify("Happy Simulator", "Joins Discord's Server ! (By I'm A Cat#7202,Altix#3395)")
...
ThingsSec:addToggle("Auto Click X1(Normal Ping)", nil, function(bool)
 _G.Click1 = bool
...
ThingsSec:addToggle("Auto Click X10(Normal Ping)", nil, function(bool)
 _G.Click2 = bool
    while _G.Click2 and rs:wait()do
for i = 1,10 do 
workspace.Events.AddClick:FireServer()
end
end
...
ThingsSec:addToggle("Auto Click X25(Raise Ping)", nil, function(bool)
 _G.Click3 = bool
    while _G.Click3 and rs:wait()do
for i = 1,25 do 
workspace.Events.AddClick:FireServer()
end
end
            ...
            spawn(function()
                while wait() do
                    if shared.toggle then
                        ...
                        me.HumanoidRootPart.CFrame = pbosd.CFrame + Vector3.new(0,9.5,0)
                       end
                    end
                end
            end)

--https://www.roblox.com/games/5253409107/Brawling-Simulator


local Library = loadstring(game:HttpGet("https://raw.githubusercontent.com/preztel/AzureLibrary/master/uilib.lua", true))()

local AutoTab = Library:CreateTab("Brawling Simulator GUI","things", true)
...
AutoTab:CreateToggle("Auto Sell", function(arg) --the (arg) is if the checkbox is toggled or not
    if arg then
        ...
        while wait(0) and _G.b do
            local A_1 = "Sell"
local Event = game:GetService("Players").quentin453.Backpack.MainGame.ZoneEntered.Event
...
local pbosd = game:GetService("Workspace").BossRing.Boss.LowerTorso

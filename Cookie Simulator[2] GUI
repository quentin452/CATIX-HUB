...
local w3 = library:CreateWindow("Cookie Simulator GUI")
local w2 = library:CreateWindow("Eggs X2")
...
w:Label("Hacks",Color3.fromRGB(38,38,38),Color3.fromRGB(0,216,111)) --BgColor,TextColor
	w:Toggle("Auto Eat",function(bool)
		shared.toggle1 = bool
	end)
	
		w:Toggle("Collect Coins",function(bool)
		shared.toggle2 = bool
end) 
w:Toggle("Auto Sell X5",function(bool)
		shared.toggle53 = bool
end) 
	spawn(function()
		while wait() do
		       if shared.toggle1 then
workspace[game.Players.LocalPlayer.Name].EatingScript.RemoteEvent:FireServer(game:GetService("Players").LocalPlayer)
end
	if shared.toggle2 then
		local root = game:service('Players').LocalPlayer.Character.HumanoidRootPart

for i, v in next, Workspace:GetDescendants() do
   if v.Name == 'OwnPart' then
	...
	if shared.toggle53 then
game.Players.LocalPlayer.character.HumanoidRootPart.CFrame = CFrame.new(1554.05725, 748.226257, -1193.06909)
wait(0.1)
game.Players.LocalPlayer.character.HumanoidRootPart.CFrame = CFrame.new(1559.11365, 755.393921, -1203.04492)
end
end
end)

local w2 = w2:CreateFolder("Eggs X2")
	w2:Dropdown("Choose Eggs",{"Standard Egg","Water Egg","Event Egg","Desert Egg","Present Egg","Santa Egg","Volcano Egg"},true,function(mob) --Replace the Dropdown name with the selected one(A,B,C)
	    _G.BossSelected = mob
	end)
...
spawn(function()
	while wait(0) do
		if shared.Eggs then
			if _G.BossSelected == "Standard Egg" then
			game:GetService("Players").LocalPlayer.PlayerGui.Main.Scripts.ClientPetBillboardsHandler.ButtonClicked:FireServer("DoubleOpening","Standard Egg")
			elseif _G.BossSelected == "Water Egg" then
			game:GetService("Players").LocalPlayer.PlayerGui.Main.Scripts.ClientPetBillboardsHandler.ButtonClicked:FireServer("DoubleOpening","Water Egg")
			elseif _G.BossSelected == "Event Egg" then
				game:GetService("Players").LocalPlayer.PlayerGui.Main.Scripts.ClientPetBillboardsHandler.ButtonClicked:FireServer("DoubleOpening","Event Egg")
			elseif _G.BossSelected == "Desert Egg" then
			game:GetService("Players").LocalPlayer.PlayerGui.Main.Scripts.ClientPetBillboardsHandler.ButtonClicked:FireServer("DoubleOpening","Desert Egg")
			elseif _G.BossSelected == "Present Egg" then
			game:GetService("Players").LocalPlayer.PlayerGui.Main.Scripts.ClientPetBillboardsHandler.ButtonClicked:FireServer("DoubleOpening","Present Egg")
			elseif _G.BossSelected == "Santa Egg" then
			game:GetService("Players").LocalPlayer.PlayerGui.Main.Scripts.ClientPetBillboardsHandler.ButtonClicked:FireServer("DoubleOpening","Santa Egg")
			elseif _G.BossSelected == "Volcano Egg" then
			game:GetService("Players").LocalPlayer.PlayerGui.Main.Scripts.ClientPetBillboardsHandler.ButtonClicked:FireServer("DoubleOpening","Volcano Egg")
			end
		end
	end
end)

...
local rs = game:GetService("RunService").RenderStepped
 venyx:Notify("Katana Legends", "Joins Discord's Server ! (By I'm A Cat#7202,Altix#3395)")
...
ThingsSec:addToggle("Auto Click(impossible to desactivate)", nil, function(bool) game:GetService("Players").LocalPlayer.Backpack.Umbrella:Destroy()
 _G.Click = bool
 while _G.Click and rs:wait()do
    local tool = game.Players.LocalPlayer.Backpack:FindFirstChildOfClass("Tool") or game.Players.LocalPlayer.Character:FindFirstChildOfClass("Tool")
    game.Players.LocalPlayer.Character.Humanoid:EquipTool(tool)
        workspace[game.Players.LocalPlayer.Name].Katana.Scripts.KatanaEvent:FireServer(false,math.huge,math.huge)
end
end)
ThingsSec:addToggle("Auto Claim Chests", nil, function(bool)
    _G.Chests = bool
       while _G.Chests and wait(5)do
        for i,v in pairs(game:GetService("Workspace").Objectives.Chests:GetChildren()) do
        game:GetService("ReplicatedStorage").Remote.ClaimChest:InvokeServer(v.Name)
       end
    end
end)
ThingsSec:addToggle("Auto Collect Coins/Backpacks", nil, function(bool)
    _G.Collect = bool
       while _G.Collect and wait(5)do
        for i,v in pairs(game:GetService("Workspace").Objectives.Pickups:GetChildren()) do
...
ThingsSec:addButton("Tp To Sell X9", function()
    game.Players.LocalPlayer.character.HumanoidRootPart.CFrame = CFrame.new(59.0735321, 34727.3086, -28.4207268)
end)
ThingsSec:addButton("Tp To Katana/Necklaces Shop", function()
    game.Players.LocalPlayer.character.HumanoidRootPart.CFrame = CFrame.new(-59.5062027, 34727.3086, 32.2216568)
end)
ThingsSec:addButton("Tp To Upgrades Shop", function()
    game.Players.LocalPlayer.character.HumanoidRootPart.CFrame = CFrame.new(-17.6977596, 34727.3086, 67.2312088)
end)
   local PageEgg = venyx:addPage("Eggs", 6252259606)
   local EggsS = PageEgg:addSection("Auto Buy Eggs:")
               EggsS:addDropdown("Select Egg",  {
           "Basic","Festival","Aqua","Royal","Robot","Samurai","Winter","Strawberry","Sandstormé","Candy","Heaven","Magma","Lapis","Midnight"},function(value)
               ...
               spawn(function()
                   while wait() do
                       if shared.toggle then
                              if _G.EggSelected == "Basic" then
                             game:GetService("ReplicatedStorage").Remote.OpenEgg:InvokeServer("Basic","Buy")
                              elseif _G.EggSelected == "Basic" then
                             game:GetService("ReplicatedStorage").Remote.OpenEgg:InvokeServer("Festival","Buy")
                              elseif _G.EggSelected == "Aqua" then
                             game:GetService("ReplicatedStorage").Remote.OpenEgg:InvokeServer("Aqua","Buy")
                              elseif _G.EggSelected == "Royal" then
                             game:GetService("ReplicatedStorage").Remote.OpenEgg:InvokeServer("Royal","Buy")
                              elseif _G.EggSelected == "Robot" then
                             game:GetService("ReplicatedStorage").Remote.OpenEgg:InvokeServer("Robot","Buy")
                              elseif _G.EggSelected == "Samurai" then
                             game:GetService("ReplicatedStorage").Remote.OpenEgg:InvokeServer("Samurai","Buy")
                              elseif _G.EggSelected == "Winter" then
                             game:GetService("ReplicatedStorage").Remote.OpenEgg:InvokeServer("Winter","Buy")
                              elseif _G.EggSelected == "Strawberry" then
                             game:GetService("ReplicatedStorage").Remote.OpenEgg:InvokeServer("Strawberry","Buy")
                              elseif _G.EggSelected == "Sandstorm" then
                             game:GetService("ReplicatedStorage").Remote.OpenEgg:InvokeServer("Sandstorm","Buy")
                              elseif _G.EggSelected == "Candy" then
                             game:GetService("ReplicatedStorage").Remote.OpenEgg:InvokeServer("Candy","Buy")
                              elseif _G.EggSelected == "Heaven" then
                             game:GetService("ReplicatedStorage").Remote.OpenEgg:InvokeServer("Heaven","Buy")
                              elseif _G.EggSelected == "Magma" then
                             game:GetService("ReplicatedStorage").Remote.OpenEgg:InvokeServer("Magma","Buy")
                              elseif _G.EggSelected == "Lapis" then
                             game:GetService("ReplicatedStorage").Remote.OpenEgg:InvokeServer("Lapis","Buy")
                              elseif _G.EggSelected == "Midnight" then
                             game:GetService("ReplicatedStorage").Remote.OpenEgg:InvokeServer("Midnight","Buy")
                           end
                       end
                   end
               end)

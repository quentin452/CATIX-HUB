...
local rs = game:GetService("RunService").RenderStepped
 venyx:Notify("Azure Mines", "Joins Discord's Server ! (By I'm A Cat#7202,Altix#3395)")
...
ThingsSec:addButton("Give Last Rank(Just Display Issue)", function()
game.Players.LocalPlayer.Level.Value = math.huge
end)
ThingsSec:addButton("Oppen Inventory", function()
game:GetService("Players").LocalPlayer.PlayerGui.ScreenGui.Storage.Visible = true
game:GetService("Players").LocalPlayer.PlayerGui.ScreenGui.Forge.Visible = false
game:GetService("Players").LocalPlayer.PlayerGui.ScreenGui.Marketplace.Visible = false
game:GetService("Players").LocalPlayer.PlayerGui.ScreenGui.Furnace.Visible = false
end)
ThingsSec:addButton("Oppen Forge    ", function()
game:GetService("Players").LocalPlayer.PlayerGui.ScreenGui.Storage.Visible = false
game:GetService("Players").LocalPlayer.PlayerGui.ScreenGui.Forge.Visible = true
game:GetService("Players").LocalPlayer.PlayerGui.ScreenGui.Marketplace.Visible = false
game:GetService("Players").LocalPlayer.PlayerGui.ScreenGui.Furnace.Visible = false
end)
ThingsSec:addButton("Oppen Market   ", function()
game:GetService("Players").LocalPlayer.PlayerGui.ScreenGui.Storage.Visible = false
game:GetService("Players").LocalPlayer.PlayerGui.ScreenGui.Forge.Visible = false
game:GetService("Players").LocalPlayer.PlayerGui.ScreenGui.Marketplace.Visible = true
game:GetService("Players").LocalPlayer.PlayerGui.ScreenGui.Furnace.Visible = false
end)
ThingsSec:addButton("Oppen Crafting ", function()
game:GetService("Players").LocalPlayer.PlayerGui.ScreenGui.Storage.Visible = false
game:GetService("Players").LocalPlayer.PlayerGui.ScreenGui.Forge.Visible = false
game:GetService("Players").LocalPlayer.PlayerGui.ScreenGui.Marketplace.Visible = false
game:GetService("Players").LocalPlayer.PlayerGui.ScreenGui.Furnace.Visible = true
end)
ThingsSec:addButton("X-Ray", function()
...
ThingsSec:addButton("Destroy All Stones", function()
...
ThingsSec:addToggle("Auto Deposit All", nil, function(bool)
    _G.Depo = (bool and true or false)
       while _G.Depo and rs:wait()do
game:GetService("ReplicatedStorage").MoveAllItems:InvokeServer()
   end
   end)
 local AutoTpStuff = Things:addSection("Auto Tp To Ore:")
    local OREBRUH  = AutoTpStuff:addDropdown("Select Ore",{
        "Stone", "Coal", "Copper", "Iron", "Silver", "Ruby", "Sapphire", "Emerald", "Sulfur", "Gold", "Diamond", "Opal", "Uranium", 
        "Moonstone", "Baryte", "Topaz", "Unobtainium", "Plutonium", "Illuminunium", "Amethyst", "Dragonglass", "Rainbonite", "Serendibite",
        "Azure", "Painite", "Kappite", "Boomite", "Ambrosia", "Twitchite", "Platinum", "Mithril"
    },function(text)
        _G.ORESELECTED = text
    end)

    AutoTpStuff:addToggle("Tp To Ore", nil, function(value,text)
    ...
    spawn(function()
        while rs:wait() do
            if shared.toggleO then
                if _G.ORESELECTED ~= nil then
                    if game.Players.LocalPlayer.Character:FindFirstChild("Humanoid") and game.Players.LocalPlayer.Character:FindFirstChild("Humanoid").Health ~= 0 then
                        game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = game:GetService("Workspace").Mine[_G.ORESELECTED].CFrame
                    end
                end
            end
        end

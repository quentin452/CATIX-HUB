--https://www.roblox.com/games/2410398108/Magic-Simulator

local Library = loadstring(game:HttpGet("https://raw.githubusercontent.com/preztel/AzureLibrary/master/uilib.lua", true))()

local AutoTab = Library:CreateTab("Magic-Simulator GUI","things", true)
...
AutoTab:CreateButton("You Can Toggle All", function() --the (arg) is if the checkbox is toggled or not
  
end)


AutoTab:CreateToggle("Auto Kill Peasant", function(arg) --the (arg) is if the checkbox is toggled or not
    if arg then
        _G.LULU = true 
...
local args = {
    [1] = workspace.NPCStorage.Peasant,
    [2] = 11,
    [3] = false,
}

game:GetService("ReplicatedStorage").Remotes.TakeDamage:FireServer(unpack(args))
end
...
AutoTab:CreateToggle("Auto Kill Archer", function(arg) --the (arg) is if the checkbox is toggled or not
    if arg then
        _G.a = true 
...
AutoTab:CreateToggle("Auto Kill Knight", function(arg) --the (arg) is if the checkbox is toggled or not
    if arg then
        _G.b = true 

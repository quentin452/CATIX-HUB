...
local w3 = library:CreateWindow("Wormface GUI")
...
w:Label("Hacks",Color3.fromRGB(38,38,38),Color3.fromRGB(0,216,111)) --BgColor,TextColor
	w:Toggle("Auto Rebirth",function(bool)
		shared.toggle3 = bool
	end)
	
		w:Toggle("Auto Tp Items",function(bool)
		shared.toggle2 = bool
end) 
	w:Toggle("Collect Items(bug)",function(bool)
		shared.toggle4 = bool
end) 
	spawn(function()
		while wait() do
...
local pbosd = game:GetService("Workspace").Items.Gem.Part
...
for i, v in next, Workspace.Items:GetDescendants() do
   if v.Name == 'Part' then

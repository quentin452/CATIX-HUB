...
venyx:Notify("Pet Zoo", "Joins Discord's Server ! (By I'm A Cat#7202,Altix#3395)")
...
ThingsSec:addToggle("Auto Click", nil, function(bool)
 _G.Click = (bool and true or false)
    while _G.Click and rs:wait()do
game:GetService("ReplicatedStorage").AeroRemoteServices.IncomeButtonService.OnClick:InvokeServer(false)
end
end)
ThingsSec:addToggle("Auto Upgrades Atlantis", nil, function(bool)
 _G.Atlantis = (bool and true or false)
    while _G.Atlantis and rs:wait()do
        for i = 1,3 do
game:GetService("ReplicatedStorage").AeroRemoteServices.ZooService.UpgradeBiome:InvokeServer("ATLANTIS",i)
end
end
end)
ThingsSec:addToggle("Auto Upgrades Volcano", nil, function(bool)
 _G.Volcano = (bool and true or false)
    while _G.Volcano and rs:wait()do
        for i = 1,3 do
game:GetService("ReplicatedStorage").AeroRemoteServices.ZooService.UpgradeBiome:InvokeServer("VOLCANO",i)
end
end
end)
ThingsSec:addToggle("Auto Upgrades Graveyard", nil, function(bool)
 _G.Graveyard = (bool and true or false)
    while _G.Graveyard and rs:wait()do
        for i = 1,3 do
game:GetService("ReplicatedStorage").AeroRemoteServices.ZooService.UpgradeBiome:InvokeServer("GRAVEYARD",i)
end
end
end)
ThingsSec:addToggle("Auto Upgrades Iceland", nil, function(bool)
 _G.Iceland = (bool and true or false)
    while _G.Iceland and rs:wait()do
        for i = 1,3 do
game:GetService("ReplicatedStorage").AeroRemoteServices.ZooService.UpgradeBiome:InvokeServer("ICELAND",i)
end
end
end)
ThingsSec:addToggle("Auto Upgrades Palace", nil, function(bool)
 _G.Palace = (bool and true or false)
    while _G.Palace and rs:wait()do
        for i = 1,3 do
game:GetService("ReplicatedStorage").AeroRemoteServices.ZooService.UpgradeBiome:InvokeServer("PALACE",i)
end
end
end)
ThingsSec:addToggle("Auto Upgrades Forest", nil, function(bool)
 _G.Forest = (bool and true or false)
    while _G.Forest and rs:wait()do
        for i = 1,3 do
game:GetService("ReplicatedStorage").AeroRemoteServices.ZooService.UpgradeBiome:InvokeServer("FOREST",i)
end
end
end)
ThingsSec:addToggle("Auto Upgrades Power_Plant", nil, function(bool)
 _G.Power = (bool and true or false)
    while _G.Power and rs:wait()do
        for i = 1,3 do
game:GetService("ReplicatedStorage").AeroRemoteServices.ZooService.UpgradeBiome:InvokeServer("POWER_PLANT",i)
end
end
end)
ThingsSec:addToggle("Auto Upgrades Aether", nil, function(bool)
 _G.Aether = (bool and true or false)
    while _G.Aether and rs:wait()do
        for i = 1,3 do
game:GetService("ReplicatedStorage").AeroRemoteServices.ZooService.UpgradeBiome:InvokeServer("AETHER",i)
end
end
end)

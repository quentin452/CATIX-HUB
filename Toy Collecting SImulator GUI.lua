...
local TEST = library:AddWindow("Catix Hub / Toy Collecting Simulator                                                                     By:I'm A Cat#7202 And Altix#3395")
...
local Tp = TEST:AddTab("Teleport")
	...
	Farming:AddButton("Inf Coins,Gems", function()
	game:GetService("ReplicatedStorage").Events.PurchaseEgg:InvokeServer("Sunset Egg",-math.huge)
    game:GetService("ReplicatedStorage").Events.PurchaseEgg:InvokeServer("Common Egg",-math.huge)
	end)
Farming:AddButton("Delete Prompt Purchase Overlay", function()
game:GetService("CoreGui").RobloxPromptGui:Destroy()
end)
    Farming:AddSwitch("Auto Farm Best Pets", function(bool)
      _G.Best23 = (bool and true or false)
    while _G.Best23 and wait() do
for i = 0,5 do
game:GetService("ReplicatedStorage").Events.DeletePet:FireServer({["Prestige"] = 0,["Name"] = "Orange Hardhat",["Position"] = 1,["Level"] = 1,["Equipped"] = false,["Experience"] = 0},"deletePet")
game:GetService("ReplicatedStorage").Events.DeletePet:FireServer({["Prestige"] = 0,["Name"] = "Blue Hardhat",["Position"] = 1,["Level"] = 1,["Equipped"] = false,["Experience"] = 0},"deletePet")
game:GetService("ReplicatedStorage").Events.PrestigePet:FireServer({["Prestige"] = i,["Name"] = "Yellow Hardhat",["Position"] = 1,["Level"] = 1,["Equipped"] = false,["Experience"] = 0},"prestigePet")
end
game:GetService("ReplicatedStorage").Events.PurchaseEgg:InvokeServer("Hard Hat Egg",3)
end
end)
game:GetService("ReplicatedStorage").Events.PurchaseEgg:InvokeServer("Hard Hat Egg",3)

	local Switch = Farming:AddSwitch("Auto Claim Quests", function(bool)
    _G.Claim = (bool and true or false)
    while _G.Claim and wait(1) do
        game:GetService("ReplicatedStorage").Events.CollectAchievement:FireServer("Coin Collector")
game:GetService("ReplicatedStorage").Events.CollectAchievement:FireServer("Gem Collector")
game:GetService("ReplicatedStorage").Events.CollectAchievement:FireServer("Egg Hatcher")
game:GetService("ReplicatedStorage").Events.CollectAchievement:FireServer("Toy Collector")
end  
	end)
		Farming:AddLabel("")
	Farming:AddLabel("******************************************************************************")
...
for i, v in pairs(game:GetService("Workspace").EggPurchases:GetChildren()) do
     EggsS:Add(v.Name)
end

Eggs:AddSwitch("Buy Eggs X3", function(bool)

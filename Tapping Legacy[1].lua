...
local rs = game:GetService("RunService").RenderStepped
 venyx:Notify("Tapping Legacy", "Joins Discord's Server ! (By I'm A Cat#7202,Altix#3395)")
...
game:GetService("ReplicatedStorage").Remotes.Main.Tap:FireServer(false)
end
end)
ThingsSec:addToggle("Auto Buy Skills", nil, function(bool)
 _G.Skills = (bool and true or false)
    while _G.Skills and rs:wait(0.5)do
        for i = 1,200 do
rs:wait (0.5)
game:GetService("ReplicatedStorage").Remotes.Misc.PurchaseSkill:FireServer(i)
rs:wait  (0.5)
end
end
end)
ThingsSec:addToggle("Auto Tp To Boss", nil, function(bool)
 _G.Boss = (bool and true or false)
    while _G.Boss and rs:wait()do
        for i , v in pairs(game:GetService("Workspace").Boss.Boss:GetChildren()) do
if game.Players.LocalPlayer.Character:FindFirstChild("Humanoid") and game.Players.LocalPlayer.Character:FindFirstChild("Humanoid").Health ~= 0 then
local me = game.Players.LocalPlayer.Character
local pbosd = game:GetService("Workspace").Boss.Boss[v.Name].HumanoidRootPart
me.HumanoidRootPart.CFrame = pbosd.CFrame + Vector3.new(0,10,0)
end
end
end
end)
...
ThingsSec:addToggle("Auto Equip Best Pets", nil, function(bool)
 _G.Bes = (bool and true or false)
    while _G.Bes and rs:wait()do
game:GetService("ReplicatedStorage").Remotes.Main.pet_Event:FireServer("Toggle",{{"All",true}})
end
end)
		local ThingsSec2 = Things:addSection("Rebirths:")
			ThingsSec2:addTextbox("Box","number",function(value)
    _G.RebSelected = value
end)
            ThingsSec2:addToggle("Buy Reb X...", nil, function(value)
                shared.toggle2 = value
            end)
            spawn(function()
                while wait() do
                    if shared.toggle2 then
 game:GetService("ReplicatedStorage").Remotes.Main.Rebirth:FireServer(tonumber(_G.RebSelected))
                    end
                end
            end)
...
local EggsS = PageEgg:addSection("Auto Buy Eggs:") 
            ...
            EggsS:addDropdown("Select Egg", SelectEggsStrings,function(value) 
                ...
                if game.Players.LocalPlayer.Character:FindFirstChild("Humanoid") and game.Players.LocalPlayer.Character:FindFirstChild("Humanoid").Health ~= 0 then
local me = game.Players.LocalPlayer.Character
local pbosd = game:GetService("Workspace").Eggs[ _G.EggSelected].Tittle
            ...
            spawn(function()
                while wait() do
                    if shared.toggle then
                        game:GetService("ReplicatedStorage").Remotes.Pets.HatchEgg:FireServer(_G.EggSelected,1)
                    end
                end
            end)
...
local section4 = Teleports:addSection("Select Island:")       
    section4:addDropdown("Dropdown", {
        ...
        elseif text ==  "Forest" then
            game.Players.LocalPlayer.character.HumanoidRootPart.CFrame = CFrame.new(-148.994812, 761.815369, 13.0626059)
        elseif text ==   "Beach" then
            game.Players.LocalPlayer.character.HumanoidRootPart.CFrame = CFrame.new(-147.044647, 1296.0885, -4.19113684)
        elseif text == "Volcano" then
            game.Players.LocalPlayer.character.HumanoidRootPart.CFrame = CFrame.new(-147.202896, 2170.95068, 2.57160687)
        elseif text == "Sweet" then
            game.Players.LocalPlayer.character.HumanoidRootPart.CFrame = CFrame.new(-163.773087, 3424.50635, -6.25103235)
        end
    end)

...
local AutoTab = Library:CreateTab("Gladiator Simulator GUI","things", true)
...
AutoTab:CreateToggle("Auto  Tp To Thanos", function(arg) --the (arg) is if the checkbox is toggled or not
    if arg then
        _G.e2 = true 
        while wait(0) and _G.e2 do
local me = game.Players.LocalPlayer.Character
local pbosd = game:GetService("Workspace").NPCSpawns.Thanos.Thanos.Head

me.HumanoidRootPart.CFrame = CFrame.new(pbosd.Position.X-0, pbosd.Position.Y-25, pbosd.Position.Z+0)        
...
eggs:CreateToggle("Auto Buy New Dragon Egg", function(arg) --the (arg) is if the checkbox is toggled or not
    if arg then
        _G.k = true 
        while wait(0) and _G.k do
            local args = {
    [1] = 1,
    [2] = workspace.Incubators.NewDragonEgg.Data,
}
...
eggs:CreateToggle("Auto Buy Toy Egg", function(arg) --the (arg) is if the checkbox is toggled or not
    if arg then
        _G.l = true 

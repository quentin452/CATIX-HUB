--https://www.roblox.com/games/3263098820/HATS-Germ-Simulator

local Library = loadstring(game:HttpGet("https://raw.githubusercontent.com/preztel/AzureLibrary/master/uilib.lua", true))()

local AutoTab = Library:CreateTab("Germ-Simulator GUI","things", true)
...
AutoTab:CreateButton("Tp All Germ", function() --the (arg) is if the checkbox is toggled or not
    
      for index, germ in pairs(workspace["Mushrooms"]:GetChildren()) do
germ.CFrame = CFrame.new(game:GetService("Players")["LocalPlayer"].Character["HumanoidRootPart"].Position)
end


  
end)
AutoTab:CreateButton("Ban Hammer Cost 20K Coins", function() --the (arg) is if the checkbox is toggled or not
local string_1 = "Tool";
local number_1 = 54; 
local Target = game:GetService("ReplicatedStorage").Remotes.BuyItem;
...
AutoTab:CreateButton("Infinite Storage Cost 799 Coins", function() --the (arg) is if the checkbox is toggled or not
     
 local string_1 = "Storage";
local number_1 = 26;
local Target = game:GetService("ReplicatedStorage").Remotes.BuyItem;
Target:InvokeServer(string_1, number_1);
...
AutoTab:CreateToggle("Auto Collect All Gems", function(arg) --the (arg) is if the checkbox is toggled or not
    if arg then
        _G.a = true 
        while wait(0) and _G.a do
   for index, coin in pairs(workspace["GemSpawn"]:GetChildren()) do
coin.CFrame = CFrame.new(game:GetService("Players")["LocalPlayer"].Character["HumanoidRootPart"].Position)
end
end
...
for index, coin in pairs(workspace["CoinSpawn"]:GetChildren()) do
coin.CFrame = CFrame.new(game:GetService("Players")["LocalPlayer"].Character["HumanoidRootPart"].Position)
end
end
...
AutoTab:CreateToggle("Auto Collect All PlaysButtons", function(arg) --the (arg) is if the checkbox is toggled or not
    if arg then
        _G.a3 = true 
        while wait(0) and _G.a3 do
for index, coin in pairs(workspace["PlaySpawn"]:GetChildren()) do
coin.CFrame = CFrame.new(game:GetService("Players")["LocalPlayer"].Character["HumanoidRootPart"].Position)
end
end
...
eggs:CreateToggle("Auto Buy 5K Coins Eggs", function(arg) --the (arg) is if the checkbox is toggled or not
    if arg then
         _G.g = true 
...
eggs:CreateToggle("Auto Buy 750K Coins Eggs", function(arg) --the (arg) is if the checkbox is toggled or not
    if arg then
         _G.j = true 
...
eggs:CreateToggle("Auto Buy 150 Plays Eggs", function(arg) --the (arg) is if the checkbox is toggled or not
    if arg then
         _G.i = true 
...
eggs:CreateToggle("Auto Buy 2,5K Plays Eggs", function(arg) --the (arg) is if the checkbox is toggled or not
    if arg then
         _G.k = true 
...
eggs:CreateToggle("Auto Buy 7,5K PlayButton Eggs", function(arg) --the (arg) is if the checkbox is toggled or not
    if arg then
         _G.h2 = true 
...
eggs:CreateToggle("Auto Buy 10K PlayButton Eggs", function(arg) --the (arg) is if the checkbox is toggled or not
    if arg then
         _G.h3 = true 
        while wait(0) and _G.h3 do     
...
eggs:CreateToggle("Auto Buy 12K PlayButton Eggs", function(arg) --the (arg) is if the checkbox is toggled or not
    if arg then
         _G.h4 = true 
        while wait(0) and _G.h4 do     
...
crates:CreateToggle("Auto Buy 1K Coins Crates", function(arg) --the (arg) is if the checkbox is toggled or not
    if arg then
         _G.h5 = true 
        while wait(0) and _G.h5 do     

local args = {
    [1] = "Coin1",
}

game:GetService("ReplicatedStorage").HatRemoteEvents.HatEclicked:FireServer(unpack(args))
end
  else
        _G.h5 = false
    end
end)
crates:CreateToggle("Auto Buy 10K Coins Crates", function(arg) --the (arg) is if the checkbox is toggled or not
    if arg then
         _G.h6 = true 
        while wait(0) and _G.h6 do     
...
crates:CreateToggle("Auto Buy 55K Coins Crate", function(arg) --the (arg) is if the checkbox is toggled or not
    if arg then
         _G.h7 = true 
        while wait(0) and _G.h7 do     
...
AutoTab:CreateButton("Sell", function() --you dont need "arg" for a button
game.Players.LocalPlayer.character.HumanoidRootPart.CFrame = CFrame.new(69.9238052, 38.3765182, 113.186668)
end)

--https://www.roblox.com/games/4233071973/X2-Energy-Energy-Simulator

local Library = loadstring(game:HttpGet("https://raw.githubusercontent.com/preztel/AzureLibrary/master/uilib.lua", true))()

local AutoTab = Library:CreateTab("Energy-Simulator GUI","things", true)
...
AutoTab:CreateButton("Best Pets FREE", function() --the (arg) is if the checkbox is toggled or not
...
game:GetService("ReplicatedStorage")["RF_AddPet"]:InvokeServer(unpack(args)) 
game:GetService("ReplicatedStorage").RF_AddPet:InvokeServer("P108Mega",0,1,"82703")   
      
end)
AutoTab:CreateButton("ATTENTION PING", function() --the (arg) is if the checkbox is toggled or not

      
end)

AutoTab:CreateToggle("Auto Kill For Gems", function(arg) --the (arg) is if the checkbox is toggled or not
    if arg then
        _G.l = true 
...
local args = {
    [1] = workspace.GemCaveNPC.GemLava.Humanoid,
    [2] = 30,
    [3] = "Gem",
    [4] = 125000,
}

game:GetService("ReplicatedStorage")["RE_DamageHumanoidNPC_DungeonGem"]:FireServer(unpack(args))
local args = {
    [1] = workspace.GemCaveNPC.GemLava.Humanoid,
    [2] = 30,
    [3] = "Gem",
...
AutoTab:CreateToggle("Auto Kill For Candy", function(arg) --the (arg) is if the checkbox is toggled or not
    if arg then
        _G.l = true 
        while wait(0) and _G.l do

local args = {
    [1] = workspace.CandyCaveNPC.LavaKiller.Humanoid,
    [2] = 45,
    [3] = "Candy",
    [4] = 20,
}

game:GetService("ReplicatedStorage")["RE_DamageHumanoidNPC_Dungeon"]:FireServer(unpack(args))
local args = {
    [1] = workspace.CandyCaveNPC.LavaKiller.Humanoid,
    [2] = 45,
    [3] = "Candy",
...
if arg then
        _G.l = true 
        while wait(0) and _G.l do
            game.Players.LocalPlayer.character.HumanoidRootPart.CFrame = CFrame.new(-147.101166, 10727.2861, -9.61042595)
            wait(0)
            game.Players.LocalPlayer.character.HumanoidRootPart.CFrame = CFrame.new(-161.258835, 10727.2861, -33.8806152)
        end
    else
        _G.l = false
    end
...
AutoTab:CreateButton("Gem Zone", function() --you dont need "arg" for a button
game.Players.LocalPlayer.character.HumanoidRootPart.CFrame = CFrame.new(2259.69775, 442.451141, 23032.6445)
end)
AutoTab:CreateButton("Candy Zone", function() --you dont need "arg" for a button
game.Players.LocalPlayer.character.HumanoidRootPart.CFrame = CFrame.new(42153.8906, 44.28479, 3482.52588)
end)
AutoTab:CreateButton("Spawn", function() --you dont need "arg" for a button
game.Players.LocalPlayer.character.HumanoidRootPart.CFrame = CFrame.new(-66.4676895, 20.3845863, -56.4029961)
end)

...
local w3 = library:CreateWindow("Button Sim 3.5")
...
w:Button("Button",function()
  game:GetService("ReplicatedStorage").Network.Port1:FireServer("Swing",{game:GetService("Workspace").BossFolder.Boss4})
	...
	w:Toggle("Collect Rebirths Buttons",function(bool)
		shared.toggle1 = bool
	end)
	w:Toggle("Collect Mega Rebirths Buttons",function(bool)
		shared.toggle111 = bool
	end)
	w:Toggle("Collect Ultra Rebirths Buttons",function(bool)
		shared.toggle11 = bool
	end)
		w:Toggle("Collect Prestige Button",function(bool)
		shared.toggle2 = bool
end) 
w:Toggle("Collect Ultra Prestige Button",function(bool)
		shared.toggle22 = bool
end) 
		w:Toggle("Collect Multiplier Button",function(bool)
		shared.toggle3 = bool
end) 
	w:Toggle("Collect VIP Multiplier Button",function(bool)
...
for i, v in next, Workspace:GetDescendants() do
   if v.Name == 'Prestige Button' then
     v.CFrame = root.CFrame
       wait()
...
for i, v in next, Workspace:GetDescendants() do
   if v.Name == 'Multiplier Button' then
     v.CFrame = root.CFrame
       wait()
...
for i, v in next, Workspace:GetDescendants() do
   if v.Name == 'Ultra Rebirth Button' then
     v.CFrame = root.CFrame
       wait()
...
for i, v in next, Workspace:GetDescendants() do
   if v.Name == 'Ultra Prestige Button' then
     v.CFrame = root.CFrame
       wait()
	...
	if shared.toggle111 then
					local root = game:service('Players').LocalPlayer.Character.HumanoidRootPart
 
for i, v in next, Workspace:GetDescendants() do
   if v.Name == 'Mega Rebirth Button' then
     v.CFrame = root.CFrame
       wait()
...
for i, v in next, Workspace:GetDescendants() do
   if v.Name == 'VIP Multiplier Button' then
     v.CFrame = root.CFrame
       wait()
...
local w2 = w2:CreateFolder("Eggs")
	w2:Dropdown("Choose Eggs",{"Common","Rare","1M","Candy","Snow","Lava","Ocean","Moon","Fall","Sand"},true,function(mob) --Replace the Dropdown name with the selected one(A,B,C)
	    _G.BossSelected = mob
	end)

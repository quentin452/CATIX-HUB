...
local reb2 = Library:CreateTab("Auto Rebirths2","things", true)
...
crates:CreateToggle("Auto Buy Crate 1", function(arg) --the (arg) is if the checkbox is toggled or not
    if arg then
        _G.cr1 = true 
        while wait(0) and _G.cr1 do
local A_1 = "Wooden Crate"
local A_2 = true
local Event = game:GetService("Workspace").Debris.Events.OpenCrate
...
eggs:CreateToggle("Auto Buy 10M Visits eggs", function(arg) --the (arg) is if the checkbox is toggled or not
    if arg then
        _G.f = true 
...
eggs:CreateToggle("Auto Buy 11M Visits eggs", function(arg) --the (arg) is if the checkbox is toggled or not
    if arg then
        _G.f22 = true 
        while wait(0) and _G.f22 do
        local args = {
    [1] = "11M Egg",
    [2] = true
}
...
eggs:CreateToggle("Auto Buy 30T Yens eggs", function(arg) --the (arg) is if the checkbox is toggled or not
    if arg then
        _G.l = true 
...
eggs:CreateToggle("Auto Buy 300T Yens eggs", function(arg) --the (arg) is if the checkbox is toggled or not
    if arg then
        _G.m = true 
...
eggs:CreateToggle("Auto Buy 5Qd Yens eggs", function(arg) --the (arg) is if the checkbox is toggled or not
    if arg then
        _G.n = true 
...
eggs:CreateToggle("Auto Buy 15Qd Yens eggs", function(arg) --the (arg) is if the checkbox is toggled or not
    if arg then
        _G.o = true 
...
eggs:CreateToggle("Auto Buy Coco eggs", function(arg) --the (arg) is if the checkbox is toggled or not
    if arg then
        _G.pn = true 
        while wait(0) and _G.pn do
local args = {
    [1] = "Coco Egg",
    [2] = true
}
...
eggs:CreateToggle("Auto Buy 10M Eggs", function(arg) --the (arg) is if the checkbox is toggled or not
    if arg then
        _G.po = true 
...
eggs:CreateToggle("Auto Buy 11M Eggs", function(arg) --the (arg) is if the checkbox is toggled or not
    if arg then
        _G.po2 = true 
        while wait(0) and _G.po2 do
local args = {
    [1] = "11M Egg",
    [2] = true
}
...
eggs:CreateToggle("Auto Buy 12M Eggs", function(arg) --the (arg) is if the checkbox is toggled or not
    if arg then
        _G.po3 = true 
        while wait(0) and _G.po3 do
local args = {
    [1] = "12M Egg",
    [2] = true
}
...
eggs:CreateToggle("Auto Buy SWAMP Eggs", function(arg) --the (arg) is if the checkbox is toggled or not
    if arg then
        _G.opp = true 
        while wait(0) and _G.opp do
local args = {
    [1] = "Swamp Egg",
    [2] = true
}
...
reb2:CreateToggle("Auto Rebirth x1Qn", function(arg) --the (arg) is if the checkbox is toggled or not
    if arg then
        _G.zt = true 
...
reb2:CreateToggle("Auto Rebirth 50Sx", function(arg) --the (arg) is if the checkbox is toggled or not
    if arg then
        _G.zt = true 
        while wait(0) and _G.zt do
           local args = {
...
reb2:CreateToggle("Auto Rebirth 500Sx", function(arg) --the (arg) is if the checkbox is toggled or not
    if arg then
        _G.zu = true 
...
reb2:CreateToggle("Auto Rebirth 1Sp", function(arg) --the (arg) is if the checkbox is toggled or not
    if arg then
        _G.zu = true 
        while wait(0) and _G.zu do
           local args = {
...
reb2:CreateToggle("Auto Rebirth 50Sp", function(arg) --the (arg) is if the checkbox is toggled or not
    if arg then
        _G.zu = true 
        while wait(0) and _G.zu do
           local args = {
...
reb2:CreateToggle("Auto Rebirth 100Sp", function(arg) --the (arg) is if the checkbox is toggled or not
    if arg then
        _G.zu = true 
        while wait(0) and _G.zu do
           local args = {
...
reb2:CreateToggle("Auto Rebirth 250Sp", function(arg) --the (arg) is if the checkbox is toggled or not
    if arg then
        _G.zu = true 
        while wait(0) and _G.zu do
           local args = {
...
reb2:CreateToggle("Auto Rebirth 500Sp", function(arg) --the (arg) is if the checkbox is toggled or not
    if arg then
        _G.zu = true 
        while wait(0) and _G.zu do
           local args = {
...
reb2:CreateToggle("Auto Rebirth 750Sp", function(arg) --the (arg) is if the checkbox is toggled or not
    if arg then
        _G.zv = true 
...
reb2:CreateToggle("Auto Rebirth 1O", function(arg) --the (arg) is if the checkbox is toggled or not
    if arg then
        _G.zw = true 
...
reb2:CreateToggle("Auto Rebirth 10O", function(arg) --the (arg) is if the checkbox is toggled or not
    if arg then
        _G.zx = true 
...
reb2:CreateToggle("Auto Rebirth 50O", function(arg) --the (arg) is if the checkbox is toggled or not
    if arg then
        _G.zy = true 
...
reb2:CreateToggle("Auto Rebirth 100O", function(arg) --the (arg) is if the checkbox is toggled or not
    if arg then
        _G.zz = true 
...
reb2:CreateToggle("Auto Rebirth 250O", function(arg) --the (arg) is if the checkbox is toggled or not
    if arg then
        _G.zza = true 
...
teleports:CreateButton("Air World", function() --you dont need "arg" for a button
game.Players.LocalPlayer.character.HumanoidRootPart.CFrame = CFrame.new(-604.856018, 112.074394, 694.230652)
end)

teleports:CreateButton("Water World", function() --you dont need "arg" for a button
game.Players.LocalPlayer.character.HumanoidRootPart.CFrame = CFrame.new(225.324036, 9.02493668, 1172.85864)
end)
teleports:CreateButton("Swamp World", function() --you dont need "arg" for a button
game.Players.LocalPlayer.character.HumanoidRootPart.CFrame = CFrame.new(1445.80127, 3.68561292, -961.31781)
end)
